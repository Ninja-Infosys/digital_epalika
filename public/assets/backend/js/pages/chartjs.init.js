...
!function (d) {
    ...
    a.prototype.respChart = function (r, e, t, o) {
        ...
        var a, r, e, t, o, n, l, s, i = [], c = ["#1abc9c", "#f1556c", "#4a81d4", "#e3eaef"];
        return 0 < d("#line-chart-example").length && (a = {
            labels: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"],
            datasets: [{
                label: "Current Week",
                backgroundColor: hexToRGB((l = (n = d("#line-chart-example").data("colors")) ? n.split(",") : c.concat())[0], .3),
                borderColor: l[0],
        ...
        }, i.push(this.respChart(d("#line-chart-example"), "Line", a, {
        ...
        }))), 0 < d("#bar-chart-example").length && (r = {
            labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
            datasets: [{
                label: "Sales Analytics",
                backgroundColor: (l = (n = d("#bar-chart-example").data("colors")) ? n.split(",") : c.concat())[0],
                borderColor: l[0],
        ...
        }, i.push(this.respChart(d("#bar-chart-example"), "Bar", r, {
            maintainAspectRatio: !1,
            legend: {display: !1},
            scales: {
        ...
        }))), 0 < d("#pie-chart-example").length && (e = {
            labels: ["Direct", "Affilliate", "Sponsored", "E-mail"],
            datasets: [{
                data: [300, 135, 48, 154],
                backgroundColor: l = (n = d("#pie-chart-example").data("colors")) ? n.split(",") : c.concat(),
                borderColor: "transparent"
            }]
        }, i.push(this.respChart(d("#pie-chart-example"), "Pie", e, {
            maintainAspectRatio: !1,
            legend: {display: !1}
        }))), 0 < d("#donut-chart-example").length && (t = {
            labels: ["Direct", "Affilliate", "Sponsored"],
            datasets: [{
                data: [128, 78, 48],
                backgroundColor: l = (n = d("#donut-chart-example").data("colors")) ? n.split(",") : c.concat(),
                borderColor: "transparent",
                borderWidth: "3"
            }]
        }, i.push(this.respChart(d("#donut-chart-example"), "Doughnut", t, {
            maintainAspectRatio: !1,
            cutoutPercentage: 60,
            legend: {display: !1}
        }))), 0 < d("#polar-chart-example").length && (o = {
            labels: ["Direct", "Affilliate", "Sponsored", "E-mail"],
            datasets: [{
                data: [251, 135, 48, 154],
                backgroundColor: l = (n = d("#polar-chart-example").data("colors")) ? n.split(",") : c.concat(),
                borderColor: "transparent"
            }]
        }, i.push(this.respChart(d("#polar-chart-example"), "PolarArea", o))), 0 < d("#radar-chart-example").length && (s = {
            labels: ["Eating", "Drinking", "Sleeping", "Designing", "Coding", "Cycling", "Running"],
            datasets: [{
                label: "Desktops",
                backgroundColor: hexToRGB((l = (n = d("#radar-chart-example").data("colors")) ? n.split(",") : c.concat())[0], .3),
                borderColor: l[0],
                ...
                label: "Tablets",
                backgroundColor: hexToRGB(l[1], .3),
                borderColor: l[1],
        ...
        }, i.push(this.respChart(d("#radar-chart-example"), "Radar", s, {maintainAspectRatio: !1}))), i
