$(window).on("load", function() {
    ...
    e.footable().on("click", ".demo-delete-row", function() {
        ...
        e.data("footable").appendRow('<tr><td style="text-align: center;"><button class="demo-delete-row btn btn-danger btn-xs btn-icon"><i class="fa fa-times"></i></button></td><td>Adam</td><td>Doe</td><td>Traffic Court Referee</td><td>22 Jun 1972</td><td><span class="badge label-table bg-success   ">Active</span></td></tr>')
    })
});
