            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="{{route('admin.estimate.labourRate.index')}}" class="btn btn-sm btn-outline-primary">
                            <i class="fa fa-list"></i>Labour Rates
                        </a>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{route('admin.estimate.labourRate.update',$labourRate)}}" method="post">
                        @csrf
                        @method('put')
                        <fieldset class="mb-2">
                            <legend> विवरण</legend>
