    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('admin.estimate.equipment.update',$equipment)}}" method="post">
                        @csrf
                        @method('put')
                        <fieldset class="mb-2">
                            <legend> विवरण</legend>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    step="any"
                                        min="0"
                                        name="er1"
                                        value="{{old('er1',$speedWithLoad[0])}}"
                                        class="form-control @error('er1') is-invalid @enderror"
                                        id="er1"
                                        placeholder="ER"
                                    />
                                    @error('er1')
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    step="any"
                                        name="gr1"
                                        min="0"
                                        value="{{old('gr1',$speedWithLoad[1])}}"
                                        class="form-control @error('gr1') is-invalid @enderror"
                                        id="gr1"
                                        placeholder="GR"
                                    />
                                    @error('gr1')
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    step="any"
                                        name="bt1"
                                        min="0"
                                        value="{{old('bt1',$speedWithLoad[2])}}"
                                        class="form-control @error('bt1') is-invalid @enderror"
                                        id="bt1"
                                        placeholder="BT"
                                    />
                                    @error('bt1')
