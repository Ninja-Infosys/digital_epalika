            ...
            <div class="card p-0">
                <div class="card-header search-card">
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="{{ route('admin.estimate.fuelRate.create') }}" class="btn btn-sm btn-outline-primary">
                            ...
                            <tbody>
                                @forelse($fuelRates as $key=>$fuelRate)
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            <a data-bs-type="edit" href="{{ route('admin.estimate.fuelRate.edit', $fuelRate) }}"
                                                class="btn btn-xs btn-outline-primary"  data-bs-toggle="tooltip" data-bs-placement="top"
                                                title="सम्पादन गर्नुहोस">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <form action="{{ route('admin.estimate.fuelRate.destroy', $fuelRate) }}" method="post">
                                                @csrf
                                                @method('delete')
