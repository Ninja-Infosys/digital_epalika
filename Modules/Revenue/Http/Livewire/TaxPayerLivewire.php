...
class TaxPayerLivewire extends Component
{
    ...
    protected function rules()
    {
        $defaultRule = [
            ...
            'taxPayerDetail.gender' => ['required', 'string', 'max:255', 'in:male,female,other'],
            'taxPayerDetail.father_name' => ['required', 'string', 'max:255'],
            'taxPayerDetail.grandfather_name' => ['required', 'string', 'max:255'],
            'taxPayerDetail.issued_district' => ['required', 'string', 'max:255'],
