    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('admin.revenue.taxPayer.update', $taxPayer)}}" method="post">
                        @csrf
                        @method('PATCH')
                        <div class="row">
                                ...
                                <select
                                    ...
                                    @foreach($taxPayerTypes as $taxPayerType)
                                        <option
                                            ...
                                            {{old('tax_payer_type_id', $taxPayer->tax_payer_type_id) == $taxPayerType->id ? 'selected' : ''}}
                                        >
                                            {{$taxPayerType->title}}
                                        </option>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input
                                    type="text"
                                    name="name_en"
                                    value="{{old('name_en', $taxPayer->name_en)}}"
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input
                                    type="text"
                                    name="phone"
                                    value="{{old('phone', $taxPayer->phone)}}"
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <select
                                    ...
                                    @foreach(\App\Enums\Gender::cases() as $gender)
                                        <option
                                            value="{{$gender->value}}"
                                            {{old('gender', $taxPayer->gender->value) == $gender->value ? 'selected' : ''}}
                                        >
                                            {{$gender->label()}}
                                        </option>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input
                                    type="text"
                                    name="father_name"
                                    value="{{old('father_name', $taxPayer->father_name)}}"
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input
                                    ...
                                    value="{{old('grandfather_name', $taxPayer->grandfather_name)}}"
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input
                                    type="text"
                                    name="citizenship_no"
                                    value="{{old('citizenship_no', $taxPayer->citizenship_no)}}"
                                ...
                                <select
                                    ...
                                    @foreach(get_districts() as $district)
                                        <option
                                            ...
                                            {{old('issued_district', $taxPayer->issued_district) == $district->district ? 'selected' : ''}}
                                        >
                                            {{$district->district}}
                                        </option>
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <select
                                    ...
                                    @foreach(get_local_bodies(localBodyId: $officeSetting->local_body_id)->ward_no as $ward)
                                        <option
                                            value="{{$ward}}"
                                            {{old('ward', $taxPayer->ward) == $ward ? 'selected' : ''}}
                                        >
                                            {{$ward}}
                                        </option>
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <textarea class="form-control @error('remarks') is_invalid @enderror" name="remarks"
                                          id="remarks" cols="30"
                                          rows="5">{{old('remarks', $taxPayer->remarks)}}</textarea>
                                @error('remarks')
                                <div class="invalid-feedback">{{$message}}</div>
                                @enderror
                            </div>
