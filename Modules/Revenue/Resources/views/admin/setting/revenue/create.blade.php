                    ...
                    <form action="{{route('admin.revenue.setting.revenue.store')}}" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                ...
                                <select
                                    ...
                                    @foreach($revenueCategories as $revenueCategory)
                                        @include('revenue::admin.setting.revenue.option' , ['revenueCategory' => $revenueCategory])
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <textarea name="remarks" class="form-control @error('remarks') is-invalid @enderror" id="remarks" cols="30" rows="5">{{old('remarks')}}</textarea>
                                @error('remarks')
                                <div class="invalid-feedback">{{$message}}</div>
                                @enderror
                            </div>
