...
class RecommendationCreate extends Model
{
    ...
    public function resolveTemplate(): string
    {
        ...
        $replaceableList->put('[@approver_signature]', '<img src="' . (approver()?->signature_photo_url ?? '') . '" width="100" height="100" alt="Signature Photo">');
        $replaceableList->put('[@checker_signature]', '<img src="' . (checker()?->signature_photo_url ?? '') . '" width="100" height="100" alt="Signature Photo">');
