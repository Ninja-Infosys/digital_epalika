                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="breadcrumb-item">
                            ...
                            <a class="ml-1 text-primary-500">सिफारिस</a>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="card-body">
                                    <div class="  d-flex justify-content-between align-items-center gap-3">
                                        <img class="icon" style="width: 40px"
                                            src="{{ asset('assets/frontend/image/sifarish.png') }}" alt="">
                                        <div class="info text-left w-75">
                                            <h5 class="mt-0 mb-1 card-title text-left">सिफारिस दर्ता</h5>
                                            <h6 class="card-text mt-2 text-left">नयाँ ‍सिफारिस दर्ता गर्नुहोस् ।</h6>
                                            <a href="{{ route('recommendationrecommendation.register') }}"
                                                class="btn btn-outline-primary btn-sm"><span>सिफारिस
                                                    दर्ता</span>
                                            </a>
                                        </div>
                                    </div>
