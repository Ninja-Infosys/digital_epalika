            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center justify-content-between">
                        <h4 class="header-title mb-0">राजस्व सूची</h4>
                        <div class="d-flex flex-wrap align-items-center">
                            <a href="{{ route('admin.recommendation.setting.revenueHeader.create') }}"
                               class="btn btn-sm btn-outline-primary">
                                <i class="fa fa-plus-circle"></i> नयाँ राजस्व थप्नुहोस
                            </a>
                        </div>
                    </div>
                </div>
                <div class="tab-content">
                    <table class="table table-sm table-striped table-bordered">
                            ...
                            <tbody>
                            @forelse ($revenueHeaders as $revenueHeader)
                                <tr>
                                    ...
                                    <td>
                                             ...
                                             <form
                                                 action="{{ route('admin.recommendation.setting.revenueHeader.destroy', $revenueHeader) }}"
                                                 method="post">
                                                 @csrf
                                                 @method('delete')
