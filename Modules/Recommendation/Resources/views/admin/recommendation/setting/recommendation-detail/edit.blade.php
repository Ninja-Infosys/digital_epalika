            ...
            <div class="card p-0">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="header-title"> सिफारिस विवरण अद्यावधिक गर्नुहोस</h4>
                ...
                <div class="card-body px-0">
                    <form action="{{ route('admin.recommendation.setting.recommendationDetail.update',$recommendationDetail) }}" method="post"
                        ...
                        <fieldset>
                            <div class="row">
                                <div class="col-md-6 mb-2">
                                    ...
                                    <select id="recommendation_category_id" name="recommendation_category_id" class="form-select" required>
                                        ...
                                        @foreach ($recommendationCategories as $recommendationCategory)
                                            <option {{ old('recommendation_category_id',$recommendationDetail->recommendation_category_id) == $recommendationCategory->id  ? 'selected' : '' }}
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input type="text" name="title" value="{{ old('title',$recommendationDetail->title) }}"
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input type="text" name="title_en" value="{{ old('title_en',$recommendationDetail->title_en) }}"
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <select id="type" name="type" class="form-select" required>
                                        ...
                                        @foreach (\Modules\Recommendation\Enums\RecommendationTypeEnum::cases() as $case)
                                            <option {{ $case->value == old('type',$recommendationDetail->type) ? 'selected' : '' }}
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <select id="revenueHeaders" name="revenueHeaders[]" class="form-select" required multiple data-toggle="select2">
                                        ...
                                        @foreach ($revenueHeaders as $revenueHeader)
                                            <option
                                                value="{{ $revenueHeader['id'] }}" {{in_array($revenueHeader['id'],$recommendationDetail->revenueHeaders->pluck('id')->toArray()) ? 'selected' : ''}}>{{$revenueHeader->title}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input type="text" name="service_cost" value="{{ old('service_cost',$recommendationDetail->service_cost) }}"
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input type="number" name="general_time" value="{{ old('general_time',$recommendationDetail->general_time) }}"
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input type="number" name="surrogate_time" value="{{ old('surrogate_time',$recommendationDetail->surrogate_time) }}"
                                ...
                                <div class="col-md-4 mb-2">
                                    <input type="checkbox" id="is_citizenship_required" name="is_citizenship_required" value="1" {{ old('is_citizenship_required',$recommendationDetail->is_citizenship_required)==1 ? 'checked':'' }}>
                                    <label for="is_citizenship_required"> नागरिकता प्रमाणपत्र (लाग्ने/नलाग्ने) </label>
                                </div>
                                <div class="col-md-4 mb-2">
                                    <input type="checkbox" id="is_applicable_org" name="is_applicable_org" value="1" {{ old('is_applicable_org',$recommendationDetail->is_applicable_org)==1 ? 'checked':'' }}>
                                    <label for="is_applicable_org">संस्थागतंलाई लागु (हुने/नहुने) </label>
                                </div>
                                <div class="col-md-4 mb-2">
                                    <input type="checkbox" id="is_applicant_self" name="is_applicant_self" value="1" {{ old('is_applicant_self',$recommendationDetail->is_applicant_self)==1 ? 'checked':'' }}>
                                    <label for="is_applicant_self">निवेदक आफु बाहेक अन्य (हुने/नहुने) </label>
                                </div>
                                <div class="col-md-4 mb-2">
                                    <input type="checkbox" id="is_permission_required" name="is_permission_required" value="1" {{ old('is_permission_required',$recommendationDetail->is_permission_required)==1 ? 'checked':'' }}>
                                    <label for="is_permission_required">मञ्जुरीनामाको विवरण आवश्यक (पर्ने/नपर्ने) </label>
                                </div>
                                <div class="col-md-4 mb-2">
                                    <input type="checkbox" id="is_taxcode_required" name="is_taxcode_required" value="1" {{ old('is_taxcode_required',$recommendationDetail->is_taxcode_required)==1 ? 'checked':'' }}>
                                    <label for="is_taxcode_required">करदाता हुनु (पर्ने/नपर्ने) </label>
                                </div>
                                <div class="col-md-4 mb-2">
                                    <input type="checkbox" id="add_land_diff_locations" name="add_land_diff_locations" value="1" {{ old('add_land_diff_locations',$recommendationDetail->add_land_diff_locations)==1 ? 'checked':'' }}>
                                    <label for="add_land_diff_locations">अन्य स्थानीय स्थरको कित्ता थप्न (मिल्ने नमिल्ने) </label>
                                </div>
                                <div class="col-md-4 mb-2">
                                    <input type="checkbox" id="is_applicable_on_recommendation" name="is_applicable_on_recommendation" value="1" {{ old('is_applicable_on_recommendation',$recommendationDetail->is_applicable_on_recommendation)==1 ? 'checked':'' }}>
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input type="number" name="order" value="{{ old('order',$recommendationDetail->order) }}"
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <select id="recommendationDocuments" name="recommendationDocuments[]" class="form-select" required multiple data-toggle="select2">
                                        ...
                                        @foreach ($recommendationDocuments as $recommendationDocument)
                                            <option
                                                value="{{ $recommendationDocument['id'] }}" {{in_array($recommendationDocument['id'],$recommendationDetail->recommendationDocuments->pluck('id')->toArray()) ? 'selected' : ''}}>{{$recommendationDocument->title}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" name="description" id="description">{{old('description',$recommendationDetail->description)}}</textarea>
                                    @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
