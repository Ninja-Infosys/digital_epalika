            ...
            <div class="card p-0">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="header-title"> सिफारिश वर्ग अद्यावधिक गर्नुहोस</h4>
                        @can('recommendationCategory_edit')
                        <a href="{{ route('admin.recommendation.setting.recommendationCategory.index') }}"
                           class="btn btn-sm btn-outline-primary">
                            <i class="fa fa-list"></i> सिफारिश वर्ग सुची
                        </a>
                        @endcan
                    </div>
                </div>
                <div class="card-body px-0">
                    <form action="{{ route('admin.recommendation.setting.recommendationCategory.update',$recommendationCategory) }}" method="post"
