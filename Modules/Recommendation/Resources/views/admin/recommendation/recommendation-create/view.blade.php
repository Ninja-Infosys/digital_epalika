                                                ...
                                                <td>
                                                    <div>
                                                        @if ($recommendationValue->type == 'image')
                                                            <img src="{{ asset('storage/' . $recommendationValue->value) ?? '' }}"
                                                                alt="" width="150">
                            ...
                            <div class="card-header">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <button class="btn btn-sm bg-transparent"
                                        style="color: #6f63e3; border: 1px solid #6f63e3;"
                                        onclick="printJS({
                                    printable: 'printBill',
                                    targetStyles: ['*'],
                                    ignoreElements: ['ignore-header'],
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-12 d-flex justify-content-between">
                                @if (
                                    $recommendationCreate->approved_status->value == 3 &&
                                        ((auth()->check() && auth()->user()->id == $recommendationSetting?->approver_id) ||
                                            auth()->user()->role_id == 1))
                                    <form method="POST"
