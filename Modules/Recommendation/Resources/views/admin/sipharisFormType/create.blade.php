        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    ...
                    <a href="{{ route('admin.recommendation.recommendationCategory.registrationDetail.index','1') }}" class="btn btn-sm btn-outline-primary">
                ...
                <form action="{{ route('admin.recommendation.sipharish.sipharishFormType.store') }}" method="post">
                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <div class="d-flex justify-content-between gap-1">
                                    <select id="personal_detail_id" name="need_approval" class="form-select personalDetail">
                                        <option value="">-- छान्नुहोस् --</option>
                    ...
                    <div class="row mt-2">
                        <div class="col-md-12 mb-2">
                            ...
                            <textarea name="content" id="recommendation_data" required cols="30" rows="10" class="form-control ckEditor @error('content') is-invalid @enderror">{{ old('content') }}</textarea>
                            @error('content')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-2">
                            <div class="d-flex align-items-center justify-content-between mb-1">
                                <label for="files" class="form-label fw-bold">आवश्यक Field <span class="text-danger">*</span></label>
                                <button type="button" class="btn btn-xs btn-outline-info" data-target-element="files" data-toggle="add-more">
                            ...
                            <fieldset class="bg-soft-secondary">
                                <div id="files">
                                    <div class="main">
                                        <div class="text-end">
                                            <button type="button" class="btn btn-sm btn-outline-danger" data-toggle="remove-parent" data-parent=".main" data-target-element="files">
                                        ...
                                        <div class="row border-bottom mb-2">
                                            <div class="col-md-6 mb-2">
                                                ...
                                                <input type="text" name="field[][field_name]" class="form-control" id="title" placeholder="शिर्षक" />
                                            </div>
                                            <div class="col-md-6 mb-2">
                                                <label for="documents" class="form-label">डकुमेन्ट </label>
                                                <select id="personal_detail_id" name="field[][status]" class="form-select personalDetail">
                                                    <option value="">-- छान्नुहोस् --</option>
                                                    <option value="1" {{old('status') == '1'?'selected':''}}>Active</option>
                                                    <option value="0" {{old('status') == '0'?'selected':''}}>Inactive</option>
                                                </select>
