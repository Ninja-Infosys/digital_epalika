                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-end">
                                        ...
                                        <p class="text-muted mb-1">जम्मा उजुरी</p>
                                    </div>
                                </div>
                            </div> <!-- end row-->
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-end">
                                        ...
                                        <p class="text-muted mb-1">जम्मा दर्ता उजुरी</p>
                                    </div>
                                </div>
                            </div> <!-- end row-->
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-end">
                                        ...
                                        <p class="text-muted mb-1">छिनोफानो भैसकेको</p>
                                    </div>
                                </div>
                            </div> <!-- end row-->
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-end">
                                        ...
                                        <p class="text-muted mb-1">नहेरीयको</p>
                                    </div>
                                </div>
                            </div> <!-- end row-->
                        </div>
