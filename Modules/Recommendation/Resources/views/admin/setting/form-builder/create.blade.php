            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{route('admin.recommendation.setting.formBuilder.index',$applicationTypeEnum)}}"> {{$applicationTypeEnum->label()}}</a>
                        </li>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('admin.recommendation.setting.formBuilder.store',$applicationTypeEnum)}}" method="post"
