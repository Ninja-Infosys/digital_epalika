...
<li class="{{request()->is('admin/recommendation/setting*') ? 'active' : ''}}">
    <a href="#recommendationSetting" {{request()->is('admin/recommendation/setting*') ? 'aria-expanded=true' : ''}}
    ...
    <div class="collapse {{request()->is('admin/recommendation/setting*') ? 'aria-expanded=true' : ''}}"
        id="recommendationSetting">
        <ul class="nav-second-level">
            @can('Recommendation_revenue_access')
