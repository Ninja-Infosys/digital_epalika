            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="{{route('admin.recommendation.registration.index')}}" class="btn btn-sm btn-outline-primary">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('admin.recommendation.setting.registration.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <fieldset>
