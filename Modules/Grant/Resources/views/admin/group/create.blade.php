            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('admin.grant.group.store')}}" method="post">
                        @csrf
                        <fieldset>
                            <legend><h3>समूहको विवरण</h3></legend>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-md-6 mb-2">
                                <label for="registered_office" class="form-label">दर्ता भएको कार्यालय *</label>
                                <input
                                    type="text"
                                    name="registered_office"
                                    value="{{old('registered_office')}}"
                                    class="form-control @error('registered_office') is-invalid @enderror"
                                    id="registered_office"
                                    placeholder="दर्ता भएको कार्यालय"
                                />
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-2">
                                ...
                                id="monthly_meeting"
                                placeholder="मासिक वैठक हुने गते"
                            />
                    ...
                    <fieldset class="mt-3">
                        <legend><h3>स्थानीय ठेगाना</h3></legend>
                        <h5 class="mt-1 text-success">नोट: कृपया क्रमशः प्रदेश, जिल्ला, गा.पा./न.पा., वार्ड नं., गाउँ र टोल छनौट गर्नुहोस् ।</h5>
                        <div class="row mt-2">
                            @livewire('address')
                            <div class="col-md-6 mb-2">
                    ...
                    <fieldset class="my-3">
                        <legend><h3>संलग्न कृषकहरू</h3></legend>
                        <h5 class="mt-1 text-success">सहकारीमा संलग्न कृषकहरू छान्नुहोस् </h5>
                        <div class="row mt-2">
                            <div class="col-md-6 mb-2">
                                <label for="farmer" class="fs-5">कृषकहरू <span
                                    class="text-danger">*</span></label>
                                <select id="farmer"
                                name="farmer" class="form-control">
                            <option value="">कृषकहरू छान्नुहोस्</option>
