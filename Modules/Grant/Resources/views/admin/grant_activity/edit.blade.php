            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h4 class="header-title">अनुदान क्रियाकलाप सम्पादन गर्नुहोस् </h4>
                ...
                <div class="card-body">
                    <form action="{{route('admin.grant.grantActivity.update',$grantActivity)}}" method="post">
                        @csrf
                        @method('put')
                        <div class="row">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="grant_recipient_type" id="grant_recipient_type"
                                                ...
                                                @foreach(\Modules\Grant\Enums\GrantRecipientTypeEnum::cases() as $grantRecipientType)
                                                    <option
                                                        {{$grantRecipientType->value==old('grant_recipient_type',$grantActivity->grant_recipient_type->value) ? 'selected' : ''}}
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input
                                            type="text"
                                            name="title"
                                            value="{{old('title',$grantActivity->title)}}"
