            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        ...
                        @can('grantType_create')
                            <a href="{{route('admin.grant.grantType.create')}}"
                        ...
                        <table class="table table-sm mb-0 table-striped table-hover">
                            ...
                            @forelse($grantTypes as $grantType)
                                <tr>
                                    ...
                                    <td>
                                        @can('grantType_edit')
                                            <a href="{{route('admin.grant.grantType.edit',$grantType)}}"
                                               class="btn btn-xs btn-outline-primary">
                                                <i class="fa fa-edit"></i> सम्पादन गर्नुहोस्
                                            </a>
                                        @endcan
                                        @can('grantType_delete')
                                            <form action="{{route('admin.grant.grantType.destroy',$grantType)}}"
                                                  method="post">
                                                @csrf
                                                @method('delete')
