                        ...
                        <fieldset class="mb-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input type="radio" id="yes1" name="is_vat_included" value="1" {{ old('is_vat_included') == 1 ?'checked':'' }}>
                                      <label for="yes1">Yes</label>
                                      <input type="radio" id="no1" name="is_vat_included" value="0" {{ old('is_vat_included') == 0 ?'checked':'' }}>
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input type="radio" id="yes" name="is_vat_needed" value="1" {{ old('is_vat_needed') == 1 ?'checked':'' }}>
                                      <label for="yes">Yes</label>
                                      <input type="radio" id="no" name="is_vat_needed" value="0" {{ old('is_vat_needed') == 0 ?'checked':'' }}>
