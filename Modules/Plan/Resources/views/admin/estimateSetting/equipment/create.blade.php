                        ...
                        <fieldset class="mb-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input type="radio" id="yes" name="is_used_for_transport" value="1" {{ old('is_used_for_transport') == 1 ? 'checked':'' }}>
                                      <label for="yes">Yes</label>
                                      <input type="radio" id="no" name="is_used_for_transport" value="0" {{ old('is_used_for_transport') == 0 ? 'checked':'' }} >
