    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h4 class="header-title">
                            प्राविधिक लागत अनुमान सम्पादन गर्नुहोस्
                        </h4>
                ...
                <div class="card-body">
                    <form action="{{route('admin.plan.project.technicalCostEstimate.update',[$project,$technicalCostEstimate])}}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                ...
                                <input
                                    type="text"
                                    name="detail"
                                    value="{{old('detail',$technicalCostEstimate->detail)}}"
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input
                                    type="number"
                                    name="number"
                                    value="{{old('number',$technicalCostEstimate->number)}}"
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input
                                    type="number"
                                    name="length"
                                    value="{{old('length',$technicalCostEstimate->length)}}"
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input
                                    type="number"
                                    name="breadth"
                                    value="{{old('breadth',$technicalCostEstimate->breadth)}}"
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input
                                    type="number"
                                    name="height"
                                    value="{{old('height',$technicalCostEstimate->height)}}"
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input
                                    type="number"
                                    name="quantity"
                                    value="{{old('quantity',$technicalCostEstimate->quantity)}}"
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input
                                    type="text"
                                    name="unit"
                                    value="{{old('unit',$technicalCostEstimate->unit)}}"
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input
                                    type="number"
                                    name="rate"
                                    value="{{old('rate',$technicalCostEstimate->rate)}}"
