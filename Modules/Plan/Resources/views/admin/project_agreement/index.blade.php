                                ...
                                <div class="main">
                                    @foreach($project->consumerCommittee?->consumerCommitteeOfficials ?? collect() as $key=>$consumerCommitteeOfficial)
                                        ...
                                        <div class="row border-bottom mb-2">
                                            <input type="hidden" name="consumerCommitteeOfficials[{{$key}}][id]"
                                                   value="{{$consumerCommitteeOfficial->id}}">
                                            <div class="col-md-4 mb-2">
                                                <label for="post" class="form-label">पद *</label>
                                                <select
                                                    name="consumerCommitteeOfficials[{{$key}}][post]"
                                                    class="form-select">
                                            ...
                                            <div class="col-md-4 mb-2">
                                                ...
                                                <input
                                                    ...
                                                    value="{{$consumerCommitteeOfficial->name}}"
                                                    class="form-control"
                                                    placeholder="नाम थर"
                                                />
                                            </div>
                                            <div class="col-md-4 mb-2">
                                                ...
                                                <input
                                                    ...
                                                    value="{{$consumerCommitteeOfficial->phone}}"
                                                    class="form-control"
                                                    placeholder="सम्पर्क नं."
                                                />
                                            </div>
                                            ...
                                            <div class="col-md-4 mb-2">
                                                ...
                                                <select
                                                    name="consumerCommitteeOfficials[{{$key}}][gender]"
                                                    class="form-select">
                                                    <option value="">छान्नुहोस्</option>
