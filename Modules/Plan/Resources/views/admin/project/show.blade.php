            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mx-3">
                        <div class="row">
                            <div class="col-md-3">
                                <h5><b>नाम :</b> {{ $project->project_name }}</h5>
                            </div>
                            <div class="col-md-3">
                                <h5><b>योजना उपस्तर :</b> {{ $project->planLevel->level_name ?? '' }}</h5>
                            </div>
                            <div class="col-md-3">
                                <h5><b>योजनाको उपक्षेत्र : </b>{{ $project->planArea->area_name ?? '' }}</h5>
                            </div>
                            <div class="col-md-3">
                                <h5><b>संचालन हुने वडा नं :</b> {{ implode(',', $project->ward_no) }}</h5>
                            </div>
                            <div class="col-md-3">
                                <h5><b>बजेट उप-शीर्षक :</b>
                            ...
                            <div class="col-md-3">
                                <h5><b>विनियोजित रकम रु. :</b> {{ $project->projectAllocatedAmounts->sum('amount') }}</h5>
                            </div>
                            <div class="col-md-3">
                                <h5><b>आयोजना स्थल :</b> {{ $project->project_venue }}</h5>
                            </div>
                            <div class="col-md-3">
                                <h5><b>मूल्याङ्कन रकम रु. :</b> {{ $project->evaluation_amount }}</h5>
                            </div>
                            <div class="col-md-3">
                                <h5><b>उद्देश्य :</b> {{ $project->purpose }}</h5>
                            </div>
                            <div class="col-md-3">
                                <h5><b>आयोजना अवस्था :</b> {{ $project->project_status?->label() }}</h5>
                            </div>
                            <div class="col-md-3">
                                <h5><b>आयोजना सुरु हुने मिति :</b> {{ $project->project_start_date }}</h5>
                            </div>
                            <div class="col-md-3">
                                <h5><b>आयोजना सम्पन्‍न हुने मिति :</b> {{ $project->project_completion_date }}</h5>
                            </div>
                            <div class="col-md-3">
                                <h5><b>वित्तीय प्रगति खर्च रकम रु. :</b> {{ $project->progress_spent_amount }}</h5>
                            </div>
                            <div class="col-md-3">
                                <h5><b>भौतिक प्रगति लक्ष्य :</b> {{ $project->physical_progress_target }}</h5>
                            </div>
                            <div class="col-md-3">
                                <h5><b>भौतिक प्रगति सम्पन्न :</b> {{ $project->physical_progress_completed }}</h5>
                            </div>
                            <div class="col-md-3">
                        ...
                        <table class="table table-sm table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>रू. {{ $project->contingency_amount }} ({{ $project->contingency_percent }} %)
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <div class="p-2">
                            ...
                            <h5>ख) मर्मत संम्भारको सम्भावित स्रोत (छ छैन खुलाउने):
                                <ul>
                                    ...
                                    <li>दस्तुर,
                                        चन्दाबाट: {{ $project->projectMaintenanceArrangement->from_fee_donation ?? '' }}
                                    </li>
