            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="inline-gap">
                        ...
                        <h5 class="d-inline"><b>विनियोजित रकम रु. :</b> {{ $project->projectAllocatedAmounts->sum('amount') }}</h5>
                    </div>
                        <div class="inline-gap">
                    ...
                    <div class="inline-gap">
                        ...
                        <h5 class="d-inline"><b>वित्तीय प्रगति खर्च रकम रु. :</b> {{ $project->progress_spent_amount }}
                        </h5>
                        <h5 class="d-inline"><b>भौतिक प्रगति लक्ष्य :</b> {{ $project->physical_progress_target }}</h5>
                        <h5 class="d-inline"><b>भौतिक प्रगति सम्पन्न :</b> {{ $project->physical_progress_completed }}
                        </h5>
                        <h5 class="d-inline"><b>भौतिक प्रगति एकाइ :</b> {{ $project->physical_progress_unit }}</h5>
                    </div>
                </div>
        </div>
    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="p-2">
                                    ...
                                    <h5>ख) मर्मत संम्भारको सम्भावित स्रोत (छ छैन खुलाउने):
                                        <ul>
                                            <li>
                                                जनश्रमदान: {{ $project->projectMaintenanceArrangement->public_service ?? '' }}</li>
                                            <li>सेवा
