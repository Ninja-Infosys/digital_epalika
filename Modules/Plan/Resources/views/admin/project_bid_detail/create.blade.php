            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="col-md-4 mb-2">
                        ...
                        <select
                            name="operated_through_change"
                            class="form-select"
                            id="operated_through_change" required {{$project->operated_through ? 'disabled' : ''}}>
                            <option value="">--- खरिद बिधि छान्नुहोस् ---</option>
                            @foreach(\Modules\Plan\Enums\ProjectOperatedThroughEnum::cases() as $operatedThrough)
                                <option
                                    {{$project->operated_through == $operatedThrough ? 'selected' : ''}}
                    ...
                    <form id="bid-form" class="d-none" action="{{route('admin.plan.project.projectBidDetail.store',$project)}}" method="post">
                        @csrf
                        <input type="hidden" name="operated_through" id="operated_through">
                        <fieldset class="mb-2">
                            ...
                            <fieldset class="mb-2">
                                ...
                                <div class="row">
                                    <div class="col-md-3 mb-2">
                                        <x-date-input-component
                                            nameNe="contract_evaluation_decision_date"
                                            labelNe="ठेक्का मुल्यांकनको निर्णय मिति"
                                            :getTodayDate="false"
                                    ...
                                    <div class="col-md-3 mb-2">
                                        <x-date-input-component
                                            nameNe="contract_acceptance_decision_date"
                                            labelNe="ठेक्का स्वीकृतीको निर्णय मिति"
                                            :getTodayDate="false"
                            ...
                            @if($project->operated_through==\Modules\Plan\Enums\ProjectOperatedThroughEnum::BID)
                                <fieldset class="mb-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-2">
                                            <x-date-input-component
                                                nameNe="performance_bond_expiry_date"
                                                labelNe="परफरमेन्स वण्ड म्याद सकिने मिति"
                                                :getTodayDate="false"
                                        ...
                                        <div class="col-md-3 mb-2">
                                            <x-date-input-component
                                                nameNe="performance_bond_extended_date"
                                                labelNe="परफरमेन्स वण्ड म्याद थपको मिति"
                                                :getTodayDate="false"
                                ...
                                <fieldset class="mb-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-2">
                                            <x-date-input-component
                                                nameNe="insurance_extended_date"
                                                labelNe="इन्स्योरेन्स म्याद थप हुने मिति"
                                                :getTodayDate="false"
                    ...
                    <form id="consumer-committee-form" class="d-none" action="{{route('admin.plan.project.projectBidDetail.store',$project)}}" method="post">
                        @csrf
                        <input type="hidden" name="operated_through" id="operated_through">
                        <fieldset class="mb-2">
                            <legend>योजना सम्झौता मिति</legend>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-2">
                                    ...
                                    <input
                                        type="number"
                                        name="beneficiary_no"
                                        class="form-control @error('beneficiary_no') is-invalid @enderror"
                                        id="beneficiary_no"
                            ...
                            <div id="budget">
                                <div class="main">
                                    ...
                                    <div class="row border-bottom mb-2">
                                        <div class="col-md-4 mb-2">
                                            <label for="amount" class="form-label">पद *</label>
                                            <select
                                        ...
                                        <div class="col-md-4 mb-2">
                                            <label for="amount" class="form-label">नाम थर *</label>
                                            <input
                                                type="text"
                                        ...
                                        <div class="col-md-4 mb-2">
                                            <label for="amount" class="form-label">सम्पर्क नं.</label>
                                            <input
                                                type="text"
                                        ...
                                        <div class="col-md-4 mb-2">
                                            <label for="amount" class="form-label">नागरिकता नं.</label>
                                            <input
                                                type="text"
                                        ...
                                        <div class="col-md-4 mb-2">
                                            <label for="amount" class="form-label">लिङ्ग</label>
                                            <select
                                        ...
                                        <div class="col-md-4 mb-2">
                                            <label for="amount" class="form-label">ठेगाना</label>
                                            <input
                                                type="text"
                                        ...
                                        <div class="col-md-4 mb-2">
                                            <label for="amount" class="form-label">बुवा/पतिको नाम</label>
                                            <input
                                                type="text"
                                        ...
                                        <div class="col-md-4 mb-2">
                                            <label for="amount" class="form-label">बाजेको नाम</label>
                                            <input
                                                type="text"
    ...
    <script>
        ...
        $(document).ready( function (){
           ...
           function setForm(operated_through){
               if(operated_through){
                   $('#operated_through').val(operated_through);
