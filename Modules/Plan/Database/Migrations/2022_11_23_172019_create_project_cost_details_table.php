...
return new class extends Migration
{
    public function up()
    {
        Schema::create('project_cost_details', function (Blueprint $table) {
            ...
            $table->double('province_invest',12,2)->default(0)->comment('प्रदेश लगानी');
            $table->double('local_level_invest',12,2)->default(0)->comment('स्थानीय तहको लगानी');
            $table->double('consumer_committee_invest',12,2)->default(0)->comment('उपभोक्ता समिति लगानी');
            $table->double('ngo_invest',12,2)->default(0)->comment('एनजीओ लगानी');
