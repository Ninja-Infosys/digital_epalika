...
class MeetingEventObserver
{
    ...
    public function created(MeetingEvent $meetingEvent)
    {
    ...
    public function updated(MeetingEvent $meetingEvent)
    {
        if ($meetingEvent->meetingEvents()->exists() || $meetingEvent->meetingEvent)
        {
            ...
            {
                if($en_start_date)
                    //$childEvent->en_start_date = Carbon::parse($childEvent->en_start_date)->addSeconds($en_start_date);
...
//            self::created($meetingEvent);
    ...
    public function deleted(MeetingEvent $meetingEvent)
    {
