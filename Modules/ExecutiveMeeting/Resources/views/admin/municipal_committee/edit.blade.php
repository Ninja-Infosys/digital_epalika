            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active"> पालिका समिति विवरण अद्यावधिक गर्नुहोस्</li>
                    </ol>
                </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h4 class="header-title">पालिका समिति विवरण अद्यावधिक गर्नुहोस्</h4>
                ...
                <div class="card-body">
                    <form action="{{route('admin.executiveMeeting.municipalCommittee.update',$municipalCommittee)}}"
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input
                                        type="text"
                                        name="name"
                                        value="{{old('name',$municipalCommittee->name)}}"
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input
                                        type="text"
                                        name="designation"
                                        value="{{old('designation',$municipalCommittee->designation)}}"
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input
                                        type="text"
                                        name="email"
                                        value="{{old('email',$municipalCommittee->email)}}"
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input
                                        type="text"
                                        name="phone"
                                        value="{{old('phone',$municipalCommittee->phone)}}"
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input
                                        type="number"
                                        name="position"
                                        value="{{old('position',$municipalCommittee->position)}}"
                        ...
                        <fieldset class="border p-2 mb-2">
                            ...
                            @livewire('address',['address'=>$municipalCommittee->address])
                            <div class="row">
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input
                                        type="text"
                                        name="village"
                                        value="{{old('village',$municipalCommittee->village)}}"
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input
                                        type="text"
                                        name="tole"
                                        value="{{old('tole',$municipalCommittee->tole)}}"
