    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('identity.admin.disabilityPrint.update', $disabilityIdentityCard) }}"
                        ...
                        <div class="card mt-3">
                            ...
                            <div id="full-detail-fields">
                                ...
                                <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <input name="fullDetail[main_training_name]"
                                                        ...
                                                        placeholder="नाम"
                                                        value="{{ old('fullDetail.main_training_name', $disabilityIdentityCard->main_training_name) ?? '' }}" />
                                                    @error('fullDetail.main_training_name')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <fieldset class="mt-3">
                                            <legend> अपाङ्गता परिचय पत्र को लागि योग्य</legend>
                                            <div class="row">
