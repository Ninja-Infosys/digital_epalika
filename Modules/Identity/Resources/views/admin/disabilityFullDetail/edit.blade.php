                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        <label for="disability_reason_id" class="form-label">अपाङ्गताको
                                            कारण</label>
                                        <select
                                            class="form-select @error('disability_reason_id') is-invalid @enderror"
                                            name="disability_reason_id"
                                            id="disability_reason_id">
                                            <option value="">---अपाङ्गताको कारण छान्नुहोस् ---</option>
                                            @foreach($disabilityReasons as $disabilityReason)
                                                <option
                                                    value="{{$disabilityReason->id}}" {{old("disability_reason_id", $disabilityIdentityCard->disability_reason_id) == $disabilityReason->id ? "selected": ""}}>{{$disabilityReason->title}}</option>
                                            @endforeach
                                        </select>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select name="citizenship_no_place" id="citizenship_no_place"
                                                ...
                                                @foreach(get_districts() as $district)
                                                    <option
                                                        value="{{$district->district}}" {{old("district", $disabilityIdentityCard->district) == $district->district ? "selected": ""}}>{{$district->district}}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <select
                                            ...
                                            @foreach(\Modules\BusinessRegistration\Enums\Qualification::cases() as $qualification)
                                                <option
                                                    value="{{$qualification->value}}" {{old("qualification", $disabilityIdentityCard->qualification?->value) == $qualification->value ? "selected" : ""}}>{{$qualification->label()}}</option>
                                            @endforeach
                                        </select>
                                        @error('qualification')
                                        <div class="invalid-feedback ">{{$message}} </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label for="daily_activity" class="form-label"> दैनिक क्रियाकलाप
                                            गर्न </label>
                                        <select
                                            class="form-select @error('daily_activity') is-invalid @enderror"
                                            name="daily_activity"
                                            id="daily_activity">
                                            <option value="">---छान्नुहोस् ---</option>

                                            <option
                                                value="1" {{old("daily_activity",$disabilityIdentityCard->daily_activity) == 1 ? "selected" : "" }}>
                                                सक्ने
                                            </option>
                                            <option
                                                value="0" {{old("daily_activity",$disabilityIdentityCard->daily_activity) == 0 ? "selected" : "" }}>
                                                नसक्ने
                                            </option>
                                        </select>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="supporting_material" class="form-label"> साहायक सामाग्री
                                            ...
                                            गर्ने </label>
                                        <select
                                            class="form-select @error('supporting_material') is-invalid @enderror"
                                            name="supporting_material"
                                            id="supporting_material">
                                            <option value="">---छान्नुहोस् ---</option>

                                            <option
                                                value="1" {{old("supporting_material",$disabilityIdentityCard->supporting_material) == 1 ? "selected" : "" }}>
                                                गरेको
                                            </option>
                                            <option
                                                value="0" {{old("supporting_material",$disabilityIdentityCard->supporting_material) == 0 ? "selected" : "" }}>
                                                नगरेको
                                            </option>
                                        </select>
                            ...
                            <fieldset class="mt-3">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-1">
                                    ...
                                    <button
                                        type="button"
                                        class="btn btn-xs btn-outline-info"
                                        data-target-element="withoutHelpingTask"
                                        data-toggle="add-more">
                                        <i class="fas fa-plus-circle"></i> नयाँ थप्नुहोस्
                                    </button>
                                </div>
                                @if($disabilityIdentityCard->withoutHelpingTask)
                                    @foreach($disabilityIdentityCard->withoutHelpingTask as $index=>$withoutHelpingTask)
                                        <div id="withoutHelpingTask">
                                            <div class="main">
                                                <div class="text-end">
                                                    <button type="button" class="btn btn-sm btn-outline-danger"
                                                            data-toggle="remove-parent" data-parent=".main"
                                                ...
                                                <div class="row border-bottom mb-2">
                                                    <div class="col-md-12 mb-2">
                                                        <label for="without_helping_task" class="form-label">कामको नाम
                                                            *</label>
                                                        <input
                                                            type="text"
                                                            name="without_helping_task[]"
                                                            value="{{old("without_helping_task[$index]",$withoutHelpingTask)}}"
                                                            class="form-control"
                                                            id="without_helping_task"
                                                            placeholder="कामको नाम"
                                                        />
                                                    </div>
                                                </div>
                                ...
                                <div id="withoutHelpingTask">
                                    <div class="main">
                                        ...
                                        <div class="row border-bottom mb-2">
                                            <div class="col-md-12 mb-2">
                                                <label for="without_helping_task" class="form-label">कामको नाम *</label>
                                                <input
                                                    type="text"
                                                    name="without_helping_task[]"
                                                    class="form-control"
