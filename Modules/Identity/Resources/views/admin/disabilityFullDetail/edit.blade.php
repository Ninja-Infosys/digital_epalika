                            ...
                            <fieldset class="mt-3">
                                ...
                                <div class="row">
                                    ...
                                    @if (!is_null($disabilityIdentityCard->citizenship_no))
                                        ...
                                        <div class="col-md-4">
                                            <x-date-input-component nameNe="citizenship_date"
                                                labelNe="नागरिकता जारि भएको मिति (बि.स.) *" nameEn="citizenship_date_ad"
                                                labelEn="नागरिकता जारि भएको मिति (ई.स.)"
                                                disable-after="{{ $todayDateInBS }}"
                                                disable-after-Ad="{{ today()->toDateString() }}" :editDateEn="$disabilityIdentityCard->citizenship_date_ad ?? ''"
