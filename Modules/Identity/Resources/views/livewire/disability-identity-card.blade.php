            ...
            @switch($currentStep)
                ...
                @case(3)
                    ...
                    <div style="display: flex;justify-content: space-between;">
                        ...
                        <div class="mt-2">
                            <button type="button" wire:click.prevent="nextStep(4)" class="btn btn-primary">
                                अर्को <i class="fa fa-arrow-right"></i>
                            </button>
                        </div>
                ...
                @case(4)
                    ...
                    <div style="display: flex;justify-content: space-between;">
                        ...
                        <div class="mt-2">
                            <button type="submit" wire:click.prevent="nextStep(5)" class="btn btn-primary">
                                अर्को <i class="fa fa-arrow-right"></i>
                            </button>
                        </div>
                ...
                @case(5)
                    <fieldset class="mt-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="form.date_bs" class="form-label"> परिचय पत्र पाएको मिति (बि.स.) </label>
                                <input
                                    name="form.date_bs"
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="form.date_ad" class="form-label"> परिचय पत्र पाएको मिति (ई.स.) </label>
                                <input
                                    name="form.date_ad"
                ...
                @case(6)
                    <fieldset class="mt-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="form.birth_registration_bs" class="form-label"> जन्म दर्ता पाएको मिति
                                    (बि.स.) </label>
                                <input
                                    name="form.birth_registration_bs"
                                    class="form-control  @error('form.birth_registration_bs') is-invalid @enderror"
                                    type="text"
                                    id="form.birth_registration_bs"
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="form.birth_registration_ad" class="form-label"> जन्म दर्ता पाएको मिति
                                    (ई.स.) </label>
                                <input
                                    name="form.birth_registration_ad"
                                    class="form-control  @error('form.birth_registration_ad') is-invalid @enderror"
                                    type="text"
                                    id="form.birth_registration_ad"
                                    placeholder="जन्म दर्ता पाएको मिति (बि.स.)"
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="form.citizenship_no_bs" class="form-label"> नागरिकता पाएको मिति
                                    (बि.स.) </label>
                                <input
                                    name="form.citizenship_no_bs"
                                    class="form-control  @error('form.citizenship_no_bs') is-invalid @enderror"
                                    type="text"
                                    id="form.citizenship_no_bs"
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="form.citizenship_no_ad" class="form-label"> नागरिकता पाएको मिति
                                    (ई.स.) </label>
                                <input
                                    name="form.citizenship_no_ad"
                                    class="form-control  @error('form.citizenship_no_ad') is-invalid @enderror"
                                    type="text"
                                    id="form.citizenship_no_ad"
                ...
                @case(7)
                    ...
                    <fieldset class="mt-3">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                {{--                                <label for="form.birth_registration_no" class="form-label">  सामाग्रीको नाम  </label>--}}
                                {{--                                <input--}}
                                {{--                                    name="form.birth_registration_no"--}}
                                {{--                                    class="form-control  @error('form.birth_registration_no') is-invalid @enderror"--}}
                                {{--                                    type="text"--}}
                ...
                @case(9)
                    ...
                    <div style="display: flex;justify-content: space-between;">
                        ...
                        <div class="mt-2">
                            <button type="button" wire:click.prevent="nextStep(10)" class="btn btn-primary">
                                अर्को <i class="fa fa-arrow-right"></i>
                            </button>
                        </div>
                    </div>
...
नागरिकता पाएको मिति "
                    ...
                    <span style="display: flex;justify-content: space-between;">
                        <div class="mt-2">
                            <button type="button" wire:click.prevent="backStep(9)" class="btn btn-primary"><i
                                    class="fa fa-arrow-left"></i> पहिलो
                            </button>
                        </div>
                        <div class="mt-2">
                ...
                @default
                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="form.dob_bs" class="form-label">जन्म मिति (बि.स.)</label>
                                <input
                                    name="form.dob_bs"
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <label for="form.dob_ad" class="form-label">जन्म मिति (ई.स.)</label>
                                <input
                                    name="form.dob_ad"
