                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <div class="d-flex">
                                        <div class="form-check">
                                            <input type="radio" class="form-check-input" name="send_email" id="send_email1" value="1"
                                            {{ old('send_email', $circularSetting) == 1 ? 'checked' : '' }}>
                                        <label class="form-check-label" for="send_email1">मिल्ने &nbsp;</label>
                                        </div>
                                        <div class="form-check">
                                            <input type="radio" class="form-check-input" name="send_email" id="send_email2" value="0"
                                            {{ old('send_email', $circularSetting) == 0 ? 'checked' : '' }}>
