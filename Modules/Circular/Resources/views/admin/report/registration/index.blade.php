            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="collapse show mb-2" id="collapseFilterForm" style="">
                        <form id="report-filter-form" data-bs-url="{{route('admin.circular.report.registration.report-data')}}">
                            <div class="row">
                                <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-2">
                                                <x-date-input-component
                                                    nameNe="from_registration_date" labelNe="मिति देखि"
                                            ...
                                            <div class="col-md-6 mb-2">
                                                <x-date-input-component
                                                    nameNe="to_registration_date" labelNe="मिति सम्म"
