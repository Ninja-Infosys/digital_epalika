                        ...
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="number" name="day_to_attend" class="form-control"
                                    value="{{ old('day_to_attend', $complaintApplication->defendantIssuedDeadline->day_to_attend ?? '') }}"
                            ...
                            <div class="col-md-6 mb-2">
                                <x-date-input-component nameNe="submitted_date" labelNe="पेश मिति *" nameEn="en_submitted_date"
                                    labelEn="Submitted Date" :editDateNe="$complaintApplication->defendantIssuedDeadline->submitted_date ?? ''" :getTodayDate="isset($complaintApplication->defendantIssuedDeadline->submitted_date) ? false : true" />
                            </div>
