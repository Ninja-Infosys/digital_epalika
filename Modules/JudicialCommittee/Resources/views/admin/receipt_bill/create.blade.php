                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input
                                    ...
                                    id="entry_person"
                                    placeholder="प्रवेश गर्ने व्यक्ति"
                                />
                                @error('entry_person')
                                <div class="invalid-feedback">{{$message}}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-2">
                                <label for="amount" class="form-label"> रकम <span
                                        class="text-danger">*</span></label>
                                <input
                                    type="number"
                                    name="amount"
                            ...
                            <div class="col-md-6 mb-2">
                                <x-date-input-component
                                    nameNe="bill_date" labelNe="बिल मिति *"
                                    nameEn="en_bill_date" labelEn="Bill Date"
                                    :editDateNe="$complaintApplication->judicialReceiptBill->bill_date??''"
                                    :getTodayDate="false"
                                />
                            </div>
                            <div class="col-md-6 mb-2">
