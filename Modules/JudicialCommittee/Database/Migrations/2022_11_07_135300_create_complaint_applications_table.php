...
return new class () extends Migration {
    public function up()
    {
        Schema::create('complaint_applications', function (Blueprint $table) {
            ...
            $table->string('complainant_relationship')->nullable()->comment('वादी नाता');
            $table->integer('complainant_age')->nullable()->comment('वादीको उमेर');
            $table->string('complainant_name')->nullable()->comment('वादीको नाम');
            $table->foreignId('defendant_province_id')->nullable()->comment('प्रतिवादीको प्रदेश')->constrained('provinces');
            $table->foreignId('defendant_district_id')->nullable()->comment('प्रतिवादीको जिल्ला')->constrained('districts');
            $table->foreignId('defendant_local_body_id')->nullable()->comment('प्रतिवादीको स्थानीय निकाय')->constrained('local_bodies');
            $table->integer('defendant_ward_no')->nullable()->comment('प्रतिवादीको वार्ड नं');
            $table->string('defendant_tole')->nullable()->comment('प्रतिवादीको टोल');
            $table->string('defendant_guardian_name')->nullable()->comment('प्रतिवादीको अभिभावकको नाम');
            $table->string('defendant_relationship')->nullable()->comment('प्रतिवादी नाता');
            $table->integer('defendant_age')->nullable()->comment('प्रतिवादीको उमेर');
