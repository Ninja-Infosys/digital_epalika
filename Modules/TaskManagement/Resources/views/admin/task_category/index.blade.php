    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">शाखाहरु अनुसार कार्यहरू </h4>
            </div>
        </div>
    </div>
    <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center justify-content-between">
                        <h4 class="header-title mb-0">शाखाहरु अनुसार कार्यहरू </h4>
                        <div class="d-flex flex-wrap align-items-center">
                            @includeIf('inc.filter_form')
                                <a href="{{route('admin.taskManagement.taskCategory.create')}}" class="btn btn-sm btn-outline-primary waves-effect waves-light">
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                        <a data-bs-type="edit" href="{{route('admin.taskManagement.taskCategory.edit',$taskCategory)}}"
