    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between">
                ...
                <a href="{{route('traineeOrganization.admin.traineeTaxClearance.create')}}" class="btn btn-outline-primary btn-xs">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex">
                                ...
                                <form action="{{route('traineeOrganization.admin.traineeTaxClearance.destroy',$taxClearance)}}"
                                      method="post">
                                    @csrf
                                    @method('delete')
