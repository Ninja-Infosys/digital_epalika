                                            ...
                                            <div class="col-md-12 mb-2">
                                                ...
                                                <select name="construction_type[]" multiple data-toggle="select2"
                                                    ...
                                                    @foreach(\Modules\EMap\Enums\TypeOfConstructionWorkEnum::cases() as $construction)
                                                        <option
                                                            value="{{$construction->value}}">{{$construction->label()}}</option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <fieldset class="border p-2 mb-2 mb-4">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mb-2">
                                                ...
                                                <select name="usage[]" id="usage" multiple
                                                        data-toggle="select2"
                                                        class="form-control">
                                                    <option disabled>--- छान्नुहोस् ---</option>
                                                    @foreach(\Modules\EMap\Enums\BuildingUsageEnum::cases() as $usage)
                                                        <option
                                                            value="{{$usage->value}}">{{$usage->label()}}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-12 mb-2">
                                                ...
                                                <select name="building_category[]" multiple data-toggle="select2"
                                                    ...
                                                    @foreach(\Modules\EMap\Enums\CategorizationEnum::cases() as $categorization)
                                                        <option
                                                            value="{{$categorization->value}}">{{$categorization->label()}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-2">
                                                ...
                                                <input type="number" name="length[from]"
                                                       value="{{old('length.from',$length['from'])}}"
                                                       id="length.from" class="form-control"
                                                >
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-2">
                                                ...
                                                <input type="number" name="length[to]"
                                                       value="{{old('length.to',$length['to'])}}"
                                                       id="length.to" class="form-control"
                                                >
                                            </div>
                                        </div>
                                    </fieldset>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-2">
                                                ...
                                                <input type="number" name="breadth[from]"
                                                       value="{{old('breadth.from',$breadth['from'])}}"
                                                       id="breadth.from" class="form-control"
                                                >
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-2">
                                                ...
                                                <input type="number" name="breadth[to]"
                                                       value="{{old('breadth.to',$breadth['to'])}}"
                                                       id="breadth.to" class="form-control"
                                                >
                                            </div>
                                        </div>
                                    </fieldset>
                                            ...
                                            <div class="col-md-12 mb-2">
                                                ...
                                                <select name="application_type[]" id="application_type" multiple
                                                    ...
                                                    @foreach(\Modules\EMap\Enums\ApplicationFormTypeEnum::cases() as $application)
                                                        <option
                                                            value="{{$application->value}}">{{$application->label()}}
                                                        </option>
                                                    @endforeach
                                                </select>
