                        ...
                        <fieldset class="border p-2 mb-2 mb-4">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input type="radio" id="yes" name="is_verified" value="1" {{ !empty($roasterSetting->is_verified) == 1 ? 'checked':'' }}>
                                      <label for="yes">Yes</label>
                                      <input type="radio" id="no" name="is_verified" value="0" {{ !empty($roasterSetting->is_verified) == 0 ? 'checked':'' }}>
