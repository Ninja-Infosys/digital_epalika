...
return new class () extends Migration {
    public function up()
    {
        Schema::create('map_applies', function (Blueprint $table) {
            ...
            $table->double('area_of_plinth', 12, 2)->comment('प्लिन्थको क्षेत्रफल');
            $table->double('length', 12, 2)->comment('कुल भवनको लम्बाई');
            $table->double('breadth', 12, 2)->comment('कुल भवनको चौडाई');
            $table->double('height', 12, 2)->comment('भवनको कुल उचाई जमिनको सतहबाट');
