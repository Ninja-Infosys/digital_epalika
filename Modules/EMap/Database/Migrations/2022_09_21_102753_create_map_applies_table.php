...
return new class () extends Migration {
    public function up()
    {
        Schema::create('map_applies', function (Blueprint $table) {
            ...
            $table->string('current_storey', 8, 2)->comment('हाल निर्माण गर्ने तल्ला संख्या');
            $table->string('future_storey', 8, 2)->comment('भविष्यमा निर्माण गर्ने तल्ला संख्या');
            $table->string('area_of_plinth', 12, 2)->nullable()->comment('प्लिन्थको क्षेत्रफल');
            $table->string('length', 12, 2)->nullable()->comment('कुल भवनको लम्बाई');
            $table->string('breadth', 12, 2)->nullable()->comment('कुल भवनको चौडाई');
            $table->string('height', 12, 2)->nullable()->comment('भवनको कुल उचाई जमिनको सतहबाट');
