                ...
                <div class="card-header p-3">
                    <div class="main-title d-flex justify-content-between">
                        ...
                        <div class="d-flex justify-content-between">
                            <x-application-component :application-type="Modules\EMap\Enums\NoticeTypeEnum::ENGINEER_APPROVAL" url="{{route('organization.admin.clients.application.apply-map-application',[$client,$mapApply])}}"></x-application-component>
                ...
                <div class="card-body p-3">
                    <div class="font-black" id="printData">
                        ...
                        <p class="mb-3">
                            ...
                            द्वारा निर्माण गर्न प्रस्ताव गरिएको भवनको स्ट्रक्चरल डिजाईन र नक्सा मैले/हामीले गरेको हो/हौ
                            ।
