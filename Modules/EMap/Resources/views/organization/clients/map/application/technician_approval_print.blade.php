        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="font-black">
                    ...
                    <p class="text-center"><b>िषय: मापदण्ड अनुसार भवन डिजाईन गरिएको सम्बन्धमा मन्जुरी पत्र ।</b></p>

                    <p>महोदय,</p>
                    <p>
                        यस {{config('applicationDetail.office_type')}} वडा नं .....<span>{{$client->ward_no}}</span>..... टोल .......<span>{{$client->tole}}</span>..... मा अवस्थित
