        ...
        <div class="card  p-0">
            ...
            <div class="card-body px-0">
                <form action="{{ route('organization.admin.storeOrganizationDocument', $mapApply) }}" method="post"
                    ...
                    <div class="col-md-6 mb-2">
                        <label class="form-label" for="structure_analysis_report">Structure Analysis Report</label>
                        <input type="file" class="form-control" id="file" name="structure_analysis_report">
                    </div>
            </div>
                        ...
                        <div class="card shadow-none border">
                            <div class="p-2">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-8">
                                        <a href="javascript:void(0);"
                                            onclick="openFileModal('Structure Analysis Report', '{{ pathinfo($mapApply->attachDocument->structure_analysis_report ?? '', PATHINFO_EXTENSION) }}', '{{ $mapApply->attachDocument->structure_analysis_report }}')"
                                        ...
                                        <p class="mb-0 font-13">
                                            {{ convert_to_highest_unit($mapApply->attachDocument->structure_analysis_report_size ?? '') }}
                                        </p>
                                    </div>
                                    <div class="col-2">
                                        ...
                                        <a class="btn btn-xs btn-outline-primary">
                                            @if ($mapApply->attachDocument?->structure_analysis_report_status == 'accept')
                                                स्वीकार
                                            @elseif ($mapApply->attachDocument?->structure_analysis_report_status == 'reject')
                                                अस्वीकार
                                            @else
                                                प्रक्रियामा
                                            @endif
