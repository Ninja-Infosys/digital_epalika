    ...
    <div class="container-fluid">
        <div class="row d-flex mt-5 ">
            <div class="col-md-10  mx-auto">
                ...
                <p>तल दिएको फर्म लाई ३ तह मा पुरा गर्नुहोस् र आफुले भरेको फर्म ठीक छ छैन प्रमाणित गरी पठाउनुहोस् ।</p>
                <div class="card-01">
                            ...
                            <mat-step [formGroupName]="'step1'" [stepControl]="horizontalStepperForm.get('step1')">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="inputfname" placeholder="बुवाको नाम">
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <label for="inputGname" class="form-label">हजुर बुवाको नाम</label>
                                        <input type="text" class="form-control" id="inputGname" placeholder="हजुर बुवाको नाम">
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="inputusername" placeholder="प्रयोगकार्तको नाम">
                                    </div>
                                    <div class="col-md-4">
                                        <label for="inputpassword" class="form-label">पासवर्ड</label>
                                        <input type="text" class="form-control" id="inputpassword" placeholder="पासवर्ड">
                                    </div>
                                    <div class="col-md-4">
                                        <label for="confirm_password" class="form-label">पासवर्ड सुनिश्चित गर्नुहोस</label>
                                        <input type="text" class="form-control" id="confirm_password" placeholder="पासवर्ड सुनिश्चित गर्नुहोस ">
                                    </div>
                                </div>
                                <br>
                                <hr>
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control" id="inputcitizen" placeholder="नागरिता न">
                                    </div>
                                    <div class="col-md-3">
                                ...
                                <div class="address">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="inputaddress" placeholder="गाउ/टोल">
                                        </div>
                                        <div class="col-md-4">
                                            <label for="inputaddresss" class="form-label">Village/Tole</label>
                                            <input type="text" class="form-control" id="inputaddresss" placeholder="Village/Tole">
                                        </div>
                                    </div>
                                </div>
                                <br>
                                ...
                                <div class="address">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="inputadd" placeholder="गाउ/टोल">
                                        </div>
                                        <div class="col-md-4">
                                            <label for="inputaddr" class="form-label">Village/Tole</label>
                                            <input type="text" class="form-control" id="inputaddr" placeholder="Village/Tole">
                                        </div>
                                    </div>
                                </div>
                                <hr>
                            ...
                            <mat-step [formGroupName]="'step3'" [stepControl]="horizontalStepperForm.get('step3')">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control" id="inpuco" placeholder="कम्पनी दर्ता न">
                                    </div>
                                ...
                                <div class="address">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="inputaddresss" placeholder="गाउ/टोल">
                                        </div>
                                        <div class="col-md-4">
                                            <label for="inputad" class="form-label">Village/Tole</label>
                                            <input type="text" class="form-control" id="inputad" placeholder="Village/Tole">
                                        </div>
                                    </div>
                                </div>
