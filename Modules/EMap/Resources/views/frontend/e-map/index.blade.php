                ...
                <div class="scroll shadow">
                    <div class="doc">
                        <table class="table px-4">
                            <thead>
                                <tr>
                                    <th class="px-4 py-2">नयाँ निर्माणको लागि नक्सा पास गर्न अनिवार्य पेश गर्नुपर्ने आवश्यक कागजातहरु</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                ...
                                <tr>
                                    <td class="px-4">३. ज.ध. दर्ता प्रमाण पूर्जामा फोटो नभएको भए नागरिता प्रमाणपत्रको प्रतिलिपि</td>
                                </tr>
                                <tr>
                                    <td class="px-4">४. कि.न. स्पष्ट भएको नापी प्रमाणित नक्सा (ब्लु प्रिन्ट)</td>
                                </tr>
                                <tr>
                                    <td class="px-4">५. पास गरिने नक्साको फोटोकपी वा ब्लुप्रिन्ट (डिजाईनर र नक्सावालाको हस्ताक्षर सहित)</td>
                                </tr>
                                <tr>
                                    <td class="px-4">६. डिजाईनरको इजाजतपत्रको नवीकरण सहितको फोटोकपी (सरोकारवालाबाट प्रमाणित)</td>
                                </tr>
                                <tr>
                                    <td class="px-4">७. मन्जुरी लिई बनाउने भएमा नक्सा वालाको कानून शाखाको रोहवरमा भएको मन्जुरीनामाको सक्कल </td>
                                </tr>
                                <tr>
                            ...
                            <tbody>
                                <tr>
                                    <td class="px-4">१. नापी नक्सामा देखिएको तर नक्सा पास नभएको खण्डमा Existing Building को भुई तल्ला प्लान चार तिरको एलिभेसन र साइट पेश गर्नुपर्नेछ </td>
                                </tr>
                                <tr>
                                    <td class="px-4">२. कागजातको हकमा नयाँ नक्सा पास गर्दा आवश्यक पर्ने सबै कागजातहरु पेश गर्नुपर्नेछ</td>
                                </tr>
                            </tbody>
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="px-4">२. चालु आर्थिक वर्षसम्मको एकिकृत सम्पति कर तिरेको रसिदको प्रतिलिपि</td>
                                </tr>
                                <tr>
                                    <td class="px-4">३. अरु कागजातको हकमा नयाँ नक्सा पास गर्दा आवश्यक पर्ने सबै कागजातहरु पेश गर्नुपर्नेछ</td>
                                </tr>
                            </tbody>
                            </thead>
                        </table>
                ...
                <div class="row">
                        ...
                        <div class="card bg-primary text-light">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <i class="fa fa-file-invoice fs-5 me-2"></i>
                    ...
                    <div class="col-md-6 p-2 mt-5">
                        <div class="card bg-success text-light">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <i class="fa fa-key fs-5 me-2"></i>
                                    <h5 class="fw-semibold mt-2">लग इन</h5>
                                </div>
                                <h6>इ-नक्सा लग इन </h6>
                                <a href="{{route('organization.login.form')}}" class="btn btn-light"><span>लग इन गर्नुहोस्</span>
                                    <i class="fa fa-angle-double-right"></i>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 p-2 mt-1">
                        <div class="card bg-danger text-light h-100">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <i class="fa fa-download fs-5 me-2"></i>
                                    <h5 class="fw-semibold mt-2">नक्सा ट्रयाक</h5>
                                </div>
                                <h6>घर नक्साको स्थिति बुझन</h6>
                                <a href="{{route('mapTrack')}}" class="btn btn-light mt-4"><span>ट्रयाक</span>
                                    <i class="fa fa-angle-double-right"></i>
                                </a>
                            </div>
                        </div>
