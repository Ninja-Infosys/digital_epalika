                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active" id="detail">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table">
                                                        ...
                                                        <tr>
                                                            <th> ठेगाना</th>
                                                            <td>
                                                                {{ $buildingDocumentation->LocalBody->local_body ?? '' }} -{{ $buildingDocumentation->ward_no ?? '' }},
                                                ...
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-8">
                                                        <a href="javascript:void(0);"
                                                           ...
                                                           class="text-muted fw-medium" type="button">नेपाली नागरिकताको
                                                            प्रमाण
                                                            पत्रको प्रतिलिपी
                                                ...
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-8">
                                                        <a href="javascript:void(0);"
                                                           ...
                                                           class="text-muted fw-medium" type="button">जग्गाधनि
                                                            प्रमाणपत्रको
                                                            प्रतिलिपी
                            ...
                            <div class="tab-pane" id="reg">
                                <form
                                    action="{{ route('emap.admin.store.customApplicationData', $buildingDocumentation) }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-2">
                                                <x-date-input-component get-today-date="{{ false }}"
                                                                        ...
                                                                        name-ne="bill_date_bs"
                                                                        label-ne="बिल मिति (बि स.)"
                                                                        name-en="bill_date_ad"
                                                                        label-en="बिल मिति"/>
                                            </div>
                                            <div class="col-md-6 mb-2">
