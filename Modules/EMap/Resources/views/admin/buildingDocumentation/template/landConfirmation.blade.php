...
<div class="row">
    <div class="col-md-12">
        <div class="card p-0">
            ...
            <a href="{{ route('emap.admin.buildingDocumentation.showToAdmin', $buildingDocumentation) }}"
                data-bs-type="edit" type="submit" title="प्रिन्ट गर्नुहोस" class="btn btn-xs btn-outline-warning">
