                ...
                <div class="card-body px-0">
                    <div id="printData">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="text-align:center; vertical-align:middle; width:50%">
                                        ...
                                        <div style=" font-size:19px; line-height:1.2">
                                            {{ get_nepali_number($buildingDocumentation->land_ward_no ?? '') }} नं वडा
                                            कार्यालय
                                        </div>
                                        <div style="font-size:19px; line-height:1.2">.............................
                                        </div>
                        ...
                        <p style="font-size:18px; text-align: justify">
                            ...
                            </span> वस्ने श्री <span class="dashed-bottom">{{ $buildingDocumentation->applicant_name }}
                            </span>ले बागचौर नगरपालिका वडा नं
                            <span class="dashed-bottom">{{ get_nepali_number($buildingDocumentation->ward_no ?? '') }}
                            </span>को साबिक <span
                            ...
                            क्षेत्रफल <span
                                class="dashed-bottom">{{ get_nepali_number($buildingDocumentation->area ?? '') }} </span>
                            को<br>
