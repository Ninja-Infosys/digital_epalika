                ...
                <form action="{{route('emap.admin.mapFee.store')}}" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-2">
                            ...
                            <input type="text" name="storey" value="{{old('storey')}}" class="form-control @error('storey') is-invalid @enderror" id="storey" placeholder="तल्ला" />
                            @error('storey')
                        ...
                        <div class="col-md-4 mb-2">
                            ...
                            <input type="number" name="rate" value="{{old('rate')}}" min="0" class="form-control @error('rate') is-invalid @enderror" id="rate" placeholder="दर" />
                            @error('rate')
                            <div class="invalid-feedback">{{$message}}</div>
                            @enderror
                        </div>
