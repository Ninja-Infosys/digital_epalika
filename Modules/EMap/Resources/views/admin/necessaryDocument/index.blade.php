    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title mb-0">आवश्यक कागजातहरू </h4>
                <div class="">
                    <ol class="breadcrumb mb-2">
                        ...
                        <li class="breadcrumb-item active">आवश्यक कागजातहरू</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="card p-0">
                <div class="card-header search-card">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="header-title mb-0">आवश्यक कागजातहरू सूची</h4>
                        @can('mapFee_create')
                            <a href="{{ route('emap.admin.necessaryDocument.create') }}" class="btn btn-sm btn-outline-primary">
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            @can('necessaryDocument_edit')
                                                <a data-bs-type="edit"
                                                    href="{{ route('emap.admin.necessaryDocument.edit', $necessaryDocument) }}"
                                            ...
                                            <form
                                                action="{{ route('emap.admin.necessaryDocument.destroy', $necessaryDocument) }}"
                                                method="post">
                                                @csrf
                                                @method('delete')
