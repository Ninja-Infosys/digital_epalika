                                        ...
                                        <td class="d-flex">
                                            @can('mapFee_edit')
                                                <a data-bs-type="edit" href="{{ route('emap.admin.form.edit', $form) }}"
                                                    class="btn btn-xs me-1 btn-outline-primary {{ get_setting('Pin') ? 'confirm_pin' : '' }}" data-bs-toggle="tooltip" data-bs-placement="top">
                                            ...
                                            <form action="{{ route('emap.admin.form.destroy', $form) }}" method="post">
                                                ...
                                                @can('mapFee_delete')
                                                    <button data-bs-type="delete"
                                                        class="btn btn-xs me-1 btn-outline-danger show_confirm {{ get_setting('Pin') ? 'confirm_pin' : 'show_confirm' }}" data-bs-toggle="tooltip" data-bs-placement="top"  title="मेटाउनु होस्">
