                        ...
                        <a href="{{ route('admin.recommendation.recommendationCategory.registrationDetail.index','') }}"
                            ...
                            <i class="fa fa-list"></i> सिफारिस सुची
                                ...
                                @livewire('emap::naksa-form', [
                                    'title' =>  $naksaForm->title,
                                    'order' =>  $naksaForm->order,
                                    'form_type' =>  $naksaForm->form_type,
                                    'need_from' =>  $naksaForm->need_from,
                                    'map_pass_group_id' =>  $naksaForm->map_pass_group_id,
                                    'fields'=>$naksaForm->formDocumentFormats,
                                    'route_name'=>$naksaForm->route_name
                                    ])
            </div>
