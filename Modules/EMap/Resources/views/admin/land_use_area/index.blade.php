                    ...
                    <table class="table table-sm table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="d-flex">
                                    <a href="{{route('emap.admin.landUseArea.edit',$landUseArea)}}" class="btn btn-xs me-1 btn-outline-primary {{get_setting('Pin')?'confirm_pin':''}}">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <form action="{{route('emap.admin.landUseArea.destroy',$landUseArea)}}" method="post">
                                        @csrf
                                        @method('delete')
                                        <button data-bs-type="delete" class="btn btn-xs me-1 btn-outline-danger show_confirm" ata-bs-toggle="tooltip" data-bs-placement="top" title="मेटाउनु होस्">
