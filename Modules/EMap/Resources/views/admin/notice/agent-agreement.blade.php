            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-8">
                    <div class="text-sm-end">
                        ...
                        <div class="btn-group mb-3">
                            <x-print-button title="{{$mapApply->client->name}}सम्झौत पत्र"/>
                        </div>
                    </div>
                </div><!-- end col-->
            </div>
                        ...
                        <div class="card-body p-3">
                            <div class="font-black" id="printData">
                                ...
                                <span>
                                    ...
                                    श्री <span class="underline-dotted ">{{$mapApply->houseOwner->father_name??''}}</span> को छोरा/छोरी/बुहारी वर्ष
                                    <span class="underline-dotted custom-width"></span>
                                    को घरधनी श्री <span class="underline-dotted ">{{$mapApply->houseOwner->name??''}}</span>(पहिलो पक्ष) र
                                    <span class="underline-dotted ">{{$mapApply->designerDetails->first()->local_body??''}}</span>
                                    वडा नं.<span class="underline-dotted ">{{$mapApply->designerDetails->first()->ward_no??''}}</span>बस्ने श्री <span
