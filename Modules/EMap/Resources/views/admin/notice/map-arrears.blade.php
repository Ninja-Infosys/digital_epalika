            ...
            <div class="card mb_30">
                <div class="card-header p-3">
                    <div class="main-title d-flex justify-content-between">
                        <h3> {{\Modules\EMap\Enums\NoticeTypeEnum::FIFTEEN_DAY_GRACE_PERIOD_FOR_MAP_PASS->label()}}</h3>
                        ...
                        <div class="card-body p-3">
                            <div class="font-black" id="printData">
                                ...
                                <p class="mb-3">
                                    ...
                                    टोल<span class="underline-dotted">{{$mapApply->landDetail->tole ?? ''}}</span> मा अवस्थित साविक <span
                                ...
                                <p class="mt-2">श्री<span class="underline-dotted">{{$mapApply->houseOwner->name??''}}</span> दरखास्त <span
                                        class="underline-dotted custom-width"></span></p>
                                <p class="mt-2">उपर्युक्त सूचना संधियारहरुलाई बुभाई निर्माण स्थलमा टास गरी वडा समिति
                                    मार्फत {{config('applicationDetail.place')}} {{config('applicationDetail.office_type')}} नगर कार्यपालिकाको कार्यालयमा चढायौ |</p>
                                ...
                                <p class="text-center my-3"><b><span class="underline-dotted custom-width"></span>मिति <span
                                            class="underline-dotted custom-width"></span>साल <span class="underline-dotted custom-width"></span>महिना
