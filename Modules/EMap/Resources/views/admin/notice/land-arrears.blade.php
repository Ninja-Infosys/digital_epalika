            ...
            <div class="card mb_30">
                <div class="card-header p-3">
                    <div class="main-title d-flex justify-content-between">
                        <h3> {{\Modules\EMap\Enums\NoticeTypeEnum::SARZAMIN_MUCHULKA->label()}}</h3>
                            ...
                            <div class="font-black" id="printData">
                                ...
                                <p class="mb-3">
                                    ...
                                    दर्ता रहेको यस {{config('applicationDetail.office_type')}} वडा नं.<span
                                        class="underline-dotted">{{$mapApply->landDetail->ward_no??''}}</span>टोल <span class="underline-dotted">{{$mapApply->landDetail->tole??''}}</span> मा
                                    अवस्थित साविक वडा नं.<span class="underline-dotted">{{$mapApply->landDetail->former_ward_no??''}}</span> कित्ता नं.<span
                                        class="underline-dotted">{{$mapApply->landDetail->plot_no??''}}</span> क्षेत्रफल<span class="underline-dotted">{{$mapApply->landDetail->unit_value??''}}  {{$mapApply->landDetail->unit->title??''}}</span>
                                    मा भवन निर्माण गर्ने घरधनी श्री <span class="underline-dotted">{{$mapApply->houseOwner->name??''}}</span> ले नक्सा
                                    ...
                                    जग्गामा कोहि कसैको सन्धि सर्पन, पिर मर्का नपर्ने देखिएको हुदाँ सो <span
                                        class="underline-dotted custom-width"></span> को नक्सा पास गरिदिएमा ठिक छ, भनेर लेखी दिएको छौ
                                ...
                                <div class="d-flex justify-content-around border">
                                    <p class="text-center ">सही छाप
                                    </p>
                                    <p>जग्गा साँध संधियारको नाम,थर
                                    </p></div>
                                <p class="text-center my-2">पूर्व वर्ष<span
                                        class="underline-dotted custom-width"></span> को श्रीमान/श्रीमती/सुश्री<span
                                        class="underline-dotted custom-width"></span></p>
                                <p class="text-center my-2">पश्चिम वर्ष<span
                                        class="underline-dotted custom-width"></span> को श्रीमान/श्रीमती/सुश्री<span
                                        class="underline-dotted custom-width"></span></p>
                                <p class="text-center my-2">उतर वर्ष<span class="underline-dotted custom-width"></span>
                                    को श्रीमान/श्रीमती/सुश्री<span class="underline-dotted custom-width"></span></p>
                                <p class="text-center my-2">दक्षिण वर्ष<span
                                        class="underline-dotted custom-width"></span> को श्रीमान/श्रीमती/सुश्री<span
                                        class="underline-dotted custom-width"></span></p>
                                <h4 class="text-decoration-underline mt-2">छिमेकि सक्षीवाला</h4>
                                <p class="d-flex justify-content-center my-2">{{config('applicationDetail.place')}} {{config('applicationDetail.office_short_name')}}<span
                                ...
                                <p>सहिछाप</p>
                                <p>१. {{config('applicationDetail.place')}} {{config('applicationDetail.office_short_name')}} वडा नं.<span class="underline-dotted custom-width"></span>
                                    बस्ने वर्ष <span class="underline-dotted custom-width"></span> को जग्गा धनी
                                    श्रीमान/श्रीमती/सुश्री <span class="underline-dotted">{{$mapApply->houseOwner->name??''}}</span></p>
                                <p class="mt-2">२. वडा नं.<span class="underline-dotted custom-width"></span>को वडा
                                    अध्यक्ष श्री <span class="underline-dotted custom-width"></span></p>
                                <p class="text-decoration-underline mt-2">काम तामेल गर्ने </p>
                                <p>प्रविधिक श्री <span class="underline-dotted custom-width"></span>पद <span
