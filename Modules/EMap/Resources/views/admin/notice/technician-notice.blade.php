                        ...
                        <div class="card-body p-3">
                            <div class="font-black" id="printData">
                                ...
                                <p class="text-center"><b>(स्थानीय सरकार संचालन ऐन २०७४ को दफा ३१ र ३२ बमोजिम सर्जमिन
                                        खटी गएको )</b></p>
                                <p class="mb-3">
                                    यस {{config('applicationDetail.office_type')}} वडा नं.<span class="underline-dotted custom-width">{{$mapApply->landDetail->ward_no??''}}</span>टोल
                                    <span class="underline-dotted custom-width">{{$mapApply->landDetail->tole??''}}</span>मा अवस्थित साविक <span
                                        class="underline-dotted custom-width">{{$mapApply->landDetail->former_ward_no??''}}</span>कित्ता नं.<span
                                        class="underline-dotted custom-width">{{$mapApply->landDetail->plot_no??''}}</span>क्षेत्रफल <span
                                        class="underline-dotted custom-width">{{$mapApply->landDetail->unit_value??''}}  {{$mapApply->landDetail->unit->title??''}}</span>मा भवन निर्माण गर्ने घरधनी श्री
                                    <span class="underline-dotted custom-width">{{$mapApply->houseOwner->name??''}}</span>ले भवन निर्माणको निमित्त पेश
                                ...
                                <p>१. भू-उपयोग क्षेत्र<span class="underline-dotted custom-width">{{$mapApply->landDetail->land_use_area??''}}</span></p>
                                ...
                                <p>२.१ बाटोको किसिम :
                                    ...
                                    <label class="form-check-label" for="inlineRadio5">अन्य भए खुलाउने <span
                                            class="underline-dotted custom-width"></span></label>
                                </p>
                                <p class="mt-2">२.२ बाटोको चौडाई<span class="underline-dotted custom-width"></span></p>
                                <p class="mt-2">२.३ मापदण्ड बमोजिमको सडक अधिकार क्षेत्रसँग साइट प्लान मेल खान्छ, खादैन
                                    सो को विवरण <span class="underline-dotted custom-width">{{$mapApply->criteriaDetails->where('detail',\Modules\EMap\Enums\DetailsRegardingCriteriaEnum::ROAD_JURISDICTION)->first()->according_to_criteria??''}}</span></p>
                                <p class="mt-2">३. निर्माण हुने भवनले सार्बजनिक स्थल वा निर्माणलाई बाधा पुर्याएको
                                    ...
                                    <input class="form-check-input form-check-inline" type="checkbox"
                                           name="inlineRadioOptions" id="inlineRadio2" value="option2">
                                    <label class="form-check-label" for="inlineRadio2">छैन&emsp;</label>सो को विवरण<span
                                        class="underline-dotted custom-width"></span>
                                </p>
                                <p class="mt-2">४. खोला/खहरे/नदी/ताल/कुलो आदि नजिक भए सो देखि </p>
                                <p class="mt-2">४.१ निर्माणको निमित्त प्रस्तावित जग्गासम्मको दुरी:<span
                                        class="underline-dotted custom-width"></span></p>
                                <p class="mt-2">४.२ प्रस्तावित भवन निर्माणको बाहिरी भागसम्मको दुरी:<span
                                        class="underline-dotted custom-width"></span></p>
                                ...
                                <p class="mt-2">५.१.१ निर्माणको निमित्त प्रस्तावित जग्गासम्मको दुरी:<span
                                        class="underline-dotted custom-width"></span></p>
                                <p class="mt-2">५.१.२ प्रस्तावित भवन निर्माणको बाहिरी भागसम्मको दुरी:<span
                                        class="underline-dotted custom-width"></span></p>
                                ...
                                <p class="mt-2">(क) भिरालो जग्गा भए <span class="underline-dotted custom-width"></span>
                                </p>
                                <p class="mt-2">(ख) भौगर्भिक धाँजा भए<span class="underline-dotted custom-width"></span>
                                </p>
                                <p class="mt-2">प्रतिवेदन पेश गर्नेको नाम:<span
                                        class="underline-dotted custom-width"></span></p>
