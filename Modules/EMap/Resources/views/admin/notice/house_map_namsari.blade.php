                        ...
                        <div class="card-body p-3">
                            <div class="font-black" id="printData">
                                ...
                                <p class="my-3">
                                    ...
                                    मा श्री<span class="underline-dotted">{{$mapApply->houseOwner->name??''}}</span> ले मिति<span
                                        class="underline-dotted custom-width"></span>
                                    मा घर निर्माणको लागि लम्बाई <span class="underline-dotted custom-width">{{$mapApply->length}}</span>
                                    चौडाई<span class="underline-dotted custom-width">{{$mapApply->breadth}}</span>
                                    उचाई<span class="underline-dotted custom-width">{{$mapApply->height}}</span> प्लिन्थ क्षेत्रफल<span
                                        class="underline-dotted custom-width">{{$mapApply->area_of_plinth}}</span>
                                    रहेको घर नक्सा पास गरी लैजानु भएकोमा मिति<span
                                        class="underline-dotted custom-width"></span> मा जिल्ला {{config('applicationDetail.office_district')}}को मालपोत
                                    कार्यालयको निर्णय
                                    अनुसार रजिस्ट्रेसन/अंशवण्डा/नामसारी/कित्ता काट बाट श्री <span
                                        class="underline-dotted custom-width">{{$mapApply->houseOwner->name??''}}</span> ले लिनु भएको प्रमाण सहित घर
                                    नक्सा नामसारीको लागि दरखास्त पर्न आएकोले यस कार्यालयबाट मिति<span
                                        class="underline-dotted custom-width"></span> मा
                                    श्री<span class="underline-dotted custom-width">{{$mapApply->landOwner->name??''}}</span> को नाममा पास भै गएको घरनक्सा
                                    ...
                                    जग्गा क्षेत्रफल<span class="underline-dotted custom-width">{{$mapApply->landDetail->unit_value??''}} {{$mapApply->landDetail->unit->title??''}}</span> रहने गरी नक्सा
