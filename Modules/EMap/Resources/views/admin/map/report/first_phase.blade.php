...
<p class="mt-2">५. नेपाल राष्ट्रिय भवन निर्माण संहिता २०६० अनुसार निर्माण
    ...
    <input class="form-check-input form-check-inline" type="checkbox" name="inlineRadioOptions" id="inlineRadio2"
           value="option2">
    <label class="form-check-label" for="inlineRadio2">नभएको</label> आंशिक पालना भएको (तपसिलको विवरणमा चिन्ह लगाउने,
    नक्सा अनुसार फरक परेमा विवरण खुलाउने)<br>
    <span class="underline-dotted custom-width"></span>
    <span class="underline-dotted custom-width"></span>
    <span class="underline-dotted custom-width"></span>
    <span class="underline-dotted custom-width"></span>
...
<table class="table table-bordered mt-3">
    ...
    <tr>
        ...
        <td><input class="form-check-input form-check-inline" type="checkbox" name="inlineRadioOptions"
