                                        ...
                                        <td class="d-flex gap-1">
                                            @can('mapFee_edit')
                                                <a data-bs-type="edit" 
                                                    ...
                                                    class="btn btn-xs me-1 btn-outline-primary {{ get_setting('Pin') ? 'confirm_pin' : '' }}" title="सम्पादन गर्नुहोस">
                                            ...
                                            @can('mapFee_delete')
                                                <form action="{{ route('emap.admin.mapPassGroup.destroy', $mapPassGroup) }}"
                                                    ...
                                                    <button data-bs-type="delete"
                                                        class="btn btn-xs me-1 btn-outline-danger show_confirm {{ get_setting('Pin') ? 'confirm_pin' : 'show_confirm' }}"  title="मेटाउनु होस्">
