                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-2">
                        ...
                        <div class="mt-2 mb-2">
                            ...
                            <div class="button-list d-flex flex-wrap mb-2">
                                ...
                                <button type="button" class="btn btn-outline-primary btn-xs" onclick="copyText('{{$templateValue}}')">
                                    {{$key}}
                                </button>
                                @endforeach
                            </div>
                    ...
                    <div class="col-md-12 mb-2">
                        ...
                        <div class="button-list d-flex flex-wrap">
                            ...
                            <button class="btn btn-outline-primary btn-xs getTemplate" data-bs-type="construction-completion-certificate">
                    ...
                    <div class="col-md-12 mb-2">
                        ...
                        <textarea name="data" id="data" cols="30" rows="10" class="form-control ckEditor @error('data') is-invalid @enderror">{{old('data')}}</textarea>
                        @error('data')
                        <div class="invalid-feedback">{{$message}}</div>
                        @enderror
                    </div>
