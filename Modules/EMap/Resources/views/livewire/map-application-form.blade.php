<form wire:submit.prevent="saveFormData" method="post"
    ...
    <div class="row d-flex">
        <label for="organization_id" class="fs-5">संस्था <span class="text-danger">*</span></label>
        ...
        <fieldset>
            <legend class="pt-2">१. प्रस्तावित भवनको विवरण</legend>
            <div class="row">
                <div class="mb-3">
                ...
                <div class="my-2">
                    <div class="form-check-primary0 d-flex">
                        <h5 class="fw-bold mt-1" for="address_check">
                            के घर धनीको विवरण र जग्गाधनीको विवरण एउटै हो?
                        </h5>
                        <div class="font px-2">
