<form wire:submit.prevent="saveFormData">
    <div class="row mb-3">
        <div class="col-md-3">
            ...
            <select wire:model="oldMap.application_type" id="application_type"
        ...
        <div class="col-md-3">
            ...
            <select wire:model="oldMap.fiscal_year_id" id="fiscal_year_id"
               class="form-select form-select-sm" required>
            ...
            <div class="col">
                @foreach(\Modules\EMap\Enums\TypeOfConstructionWorkEnum::cases() as $constructionType)
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" wire:model="oldMap.construction_type"
        ...
        <div class="mb-3">
            ...
            <div class="col">
                @foreach(\Modules\EMap\Enums\BuildingUsageEnum::cases() as $usages)
                    <div class="form-check form-check-inline">
                        <input type="radio" class="form-check-input" id="{{$usages->name}}" wire:model="oldMap.usage"
                               value="{{$usages->value}}">
    ...
    <fieldset>
        <legend><h5>४. घर धनीको विवरण</h5></legend>
        <div class="row">
