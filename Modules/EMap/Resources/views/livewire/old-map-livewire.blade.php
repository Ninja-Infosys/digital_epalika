    ...
    <div class="row mb-3">
        <div class="col-md-3">
            ...
            <select wire:model="oldMap.application_type" id="application_type" class="form-select form-select-sm" required>
                ...
                <option value="{{$applicationFormTypeEnum->value}}">{{$applicationFormTypeEnum->label()}}</option>
                @endforeach
            </select>
        ...
        <div class="col-md-2">
            ...
            <input class="form-control form-control-sm" type="text" id="oldMap" wire:model="oldMap.registration_no" placeholder="दर्ता नं.">
        ...
        <div class="col-md-2">
            ...
            <input class="form-control form-control-sm" type="number" step="any" id="registration_fee" wire:model="oldMap.registration_fee" placeholder="दर्ता रकम">
        ...
        <div class="col-md-2">
            ...
            <input class="form-control form-control-sm" type="text" id="registration_date" wire:model="oldMap.registration_date" placeholder="दर्ता मिति">
    ...
    <div class="card border border-1 round-1">
        ...
        <div class="mb-3">
            ...
            <div class="col mt-1">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input mt-1 mb-1" type="radio" wire:model="oldMap.construction_type" id="{{$constructionType->name}}" value="{{$constructionType->value}}">
                    <label class="form-check-label mt-1 mb-1" for="{{$constructionType->name}}">{{$constructionType->label()}}</label>
                </div>
                @endforeach
        ...
        <div class="mb-3">
            ...
            <div class="col mt-1">
                ...
                <div class="form-check form-check-inline">
                    <input type="radio" class="form-check-input mt-1 mb-1" id="{{$usages->name}}" wire:model="oldMap.usage" value="{{$usages->value}}">
                    <label class="form-check-label mt-1 mb-1" for="{{$usages->name}}">{{$usages->label()}}</label>
                </div>
                @endforeach
                @error('oldMap.usage')
                <p class="text-danger">{{$message}}</p>
        ...
        <div class="mb-3">
            ...
            <div class="col mt-1">
                ...
                <div class="form-check form-check-inline">
                    <input type="radio" class="form-check-input mt-1 mb-1" id="{{$categorization->name}}" wire:model="oldMap.building_category" value="{{$categorization->value}}">
                    <label class="form-check-label mt-1 mb-1" for="{{$categorization->name}}">{{$categorization->label()}}</label>
                </div>
                @endforeach
    ...
    <div class="card border border-1 round-1 mt-3">
        ...
        <div class="row">
            <div class="col-md-4 mb-3">
                ...
                <input class="form-control form-control-sm mt-1" type="text" id="houseOwner.name" wire:model="houseOwner.name" placeholder=" जग्गा धनीको नाम">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input class="form-control form-control-sm mt-1" type="text" id="houseOwner.phone" wire:model="houseOwner.phone" placeholder="फोन नं.">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input class="form-control form-control-sm mt-1" type="text" id="houseOwner.father_name" wire:model="houseOwner.father_name" placeholder="बुवाको नाम">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input class="form-control form-control-sm mt-1" type="text" id="houseOwner.grandfather_name" wire:model="houseOwner.grandfather_name" placeholder="हजुरबुबाको नाम">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input class="form-control form-control-sm mt-1" type="text" id="houseOwner.citizenship_no" wire:model="houseOwner.citizenship_no" placeholder="नागरिकता नम्बर">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input class="form-control form-control-sm mt-1" type="text" id="houseOwner.citizenship_issue_date" wire:model="houseOwner.citizenship_issue_date" placeholder="yyyy/mm/dd">
            ...
            <div class="col-md-4 mb-3">
                <label class="form-label" for="houseOwner.citizenship_issue_district_id">१.५ नागरिकता लिएको
                    जिल्ला</label>
                <select class="form-select form-select-sm mt-1" wire:model="houseOwner.citizenship_issue_district_id" id="houseOwner.citizenship_issue_district_id">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input class="form-control form-control-sm mt-1" type="text" id="houseOwner.address" wire:model="houseOwner.address" placeholder="ठेगाना">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input class="form-control form-control-sm mt-1" type="text" id="houseOwner.local_body" wire:model="houseOwner.local_body" placeholder="पालिका">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input class="form-control form-control-sm mt-1" type="number" id="houseOwner.ward_no" wire:model="houseOwner.ward_no" min="0" placeholder="वडा नं.">
