<div class="card-body">
                @if ($errors->any())
                    ...
                    @endif
                    <form action="{{ route('emap.admin.enaksa.naksaForm.store') }}" method="post"
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input type="text" class="form-control personalDetail" wire:model="title" name="title"/>
                                    </div>
                                    @error('title')
                                ...
                                <label for="order" class="form-label">क्रम शन्ख्य </label>
                                    <div class="d-flex justify-content-between gap-1">
                                    <input type="number" class="form-control personalDetail" wire:model="order" name="order"/>
                                    </div>
                                    @error('order')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    ...
                                    <div class="col-md-4 mb-2">
                                        ...
                                        <select id="form_type" name="form_type" wire:model="form_type" class="form-select" required>
                                    ...
                                    <div class="col-md-4 mb-2">
                                        ...
                                        <select id="map_pass_group_id" name="map_pass_group_id" wire:model="map_pass_group_id" class="form-select" required>
                                            <option value="">-- छान्नुहोस् --</option>
                                    ...
                                    <div class="col-md-4 mb-2">
                                        <label for="need_from" class="form-label">Need from</label>
                                        <select id="need_from" name="need_from" wire:model="need_from" class="form-select" required>
                                            <option value="">-- छान्नुहोस् --</option>
                                    ...
                                    <div class="col-md-4 mb-2">
                                        ...
                                        <div class="d-flex justify-content-between gap-1">
                                            <input type="text" class="form-control personalDetail" wire:model="route_name" name="route_name"/>
                                        </div>
                                        @error('route_name')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
