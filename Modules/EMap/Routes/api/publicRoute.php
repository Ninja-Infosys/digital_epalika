...
use Modules\EMap\Http\Controllers\Admin\Api\BuildingApplicationApiController;
...
Route::get("buildingApplicationSetting", [BuildingApplicationApiController::class, 'getBuildingSetting'])->name('get-building-setting');
...
Route::post('building-application', [MapApplicationController::class,'registerBuildingApplication'])->name('register-building-application');
