...
class UpdateBuildingApplicationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'current_storey' => ['required', 'integer'],
            'building_category' => ['nullable', new Enum(BuildingTypeEnum::class)],
            'building_usage' => ['nullable', new Enum(BuildingUsageEnum::class)],
            'roof_category' => ['nullable', new Enum(RoofTypeEnum::class)],
            'height' => ['required'],
