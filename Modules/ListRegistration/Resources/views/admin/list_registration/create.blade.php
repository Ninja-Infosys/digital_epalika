                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input type="file" name="license_photo"
                                    ...
                                    id="license_photo">
                                <div id="license_photo" class="form-text">जुन खरिद को लागि सूची दर्ता हुन निबेदन दिने हो
                                </div>
                                @error('license_photo')
                                <div class="invalid-feedback">{{$message}}</div>
                                @enderror
                    ...
                    <fieldset class="mb-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <textarea name="business_nature_description" id="business_nature_description"
                                    placeholder="बिबरण" required
