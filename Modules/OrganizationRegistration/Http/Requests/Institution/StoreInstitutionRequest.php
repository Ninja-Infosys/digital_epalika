...
class StoreInstitutionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'institutionOfficers.*.officer_designation' => ['required'],
            'institutionOfficers.*.officer_name' => ['required'],
            'institutionOfficers.*.officer_citizenship_no' => ['required'],
            'institutionOfficers.*.officer_citizenship_issue_date' => ['required'],
            'institutionOfficers.*.officer_citizenship_issue_date_en' => ['required'],
            'institutionOfficers.*.officer_citizenship_issue_district' => ['required'],
            'institutionOfficers.*.officer_citizenship_issue_current_address' => ['required'],
            'institutionOfficers.*.officer_contact_detail' => ['required'],
            'institutionOfficers.*.officer_photo' => ['required', 'mimes:jpg,png,jpeg'],
            'institutionOfficers.*.officer_citizenship_front' => ['required', 'mimes:jpg,png,jpeg'],
            'institutionOfficers.*.officer_citizenship_behind' => ['required', 'mimes:jpg,png,jpeg'],
        ];
    }
}
