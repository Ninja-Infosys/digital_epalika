            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">व्यवसायको नवीकरण थप्नुहोस</li>
                    </ol>
                </div>
                <h4 class="page-title">व्यवसायको नवीकरण थप्नुहोस</h4>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h4 class="header-title">व्यवसायको नवीकरण थप्नुहोस</h4>
                ...
                <div class="card-body">
                    <form action="{{route('admin.organizationRegistration.business.businessRenew.store',$business)}}" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" required="" name="fiscal_year_id"
                                        ...
                                        @foreach($fiscalYears as $fiscalYear)
                                            <option value="{{$fiscalYear->id}}" {{old('fiscal_year_id') == $fiscalYear->id ? 'selected' : ''}}>{{$fiscalYear->title}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="renew_amount"
                                           id="renew_amount" value="{{old('renew_amount')}}"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="penalty_amount"
                                           id="penalty_amount" value="{{old('penalty_amount')}}"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="payment_receipt"
                                           id="payment_receipt" value="{{old('payment_receipt')}}"
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <label class="form-label" for="customFile">कार्यसमितिको निर्णय</label>
                                <input type="file" class="form-control" id="customFile"/>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label" for="customFile">अडीट रिपोर्ट</label>
                                <input type="file" class="form-control" id="customFile"/>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label" for="customFile">साधारण सभा निर्णय</label>
                                <input type="file" class="form-control" id="customFile"/>
                            </div>
                            <div class="col-md-4 mt-2">
                                <label class="form-label" for="customFile">वार्डको सिफारिस</label>
                                <input type="file" class="form-control" id="customFile"/>
                            </div>
                        </div>
