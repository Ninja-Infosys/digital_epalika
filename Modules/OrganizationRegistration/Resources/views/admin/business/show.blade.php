                ...
                <div class="card-body">
                    <div class="text-start mt-3">
                        ...
                        <div class="text-start mt-3">
                            ...
                            <p class="border-bottom border-1 text-dark mb-2 font-16"><strong>व्यवसायीको नाम :</strong> <span
                                    class="ms-2 text-muted">{{ $business->address }}
                                </span></p>
                            <p class="border-bottom border-1 text-dark mb-2 font-16"><strong>नागरिकता नम्बर :</strong> <span
                                    class="ms-2 text-muted">{{ $business->address }}
                                </span></p>
                            <p class="border-bottom border-1 text-dark mb-2 font-16"><strong>नागरिकता जारी मिति :</strong>
                                <span class="ms-2 text-muted">{{ $business->address }}
                                </span></p>
                            <p class="border-bottom border-1 text-dark mb-2 font-16"><strong>नागरिकता जारी जिल्ला :</strong>
                                <span class="ms-2 text-muted">{{ $business->address }}
                                </span></p>
                            <p class="border-bottom border-1 text-dark mb-2 font-16"><strong>व्यवसाय रहने घर/जग्गाधनीको नाम
                                    :</strong> <span class="ms-2 text-muted">{{ $business->address }}
                                </span></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="text-start mt-3">
                        ...
                        <div class="text-start mt-3">
                            ...
                            <p class="border-bottom border-1 text-dark mb-2 font-16"><strong>नविकरण गरिएको मिति
                                    :</strong>
                                <span class="ms-2 text-muted">{{ $business->registration_date }}</span>
                            </p>
                            <p class="border-bottom border-1 text-dark mb-2 font-16"><strong>नविकरण कायम रहने
                                    मिति:</strong>
                                <span class="ms-2 text-muted">{{ $business->registration_date }}</span>
                            </p>
                            <p class="border-bottom border-1 text-dark mb-2 font-16"><strong>नविकरण दस्तुर रसिद
                                    नं:</strong>
                                <span class="ms-2 text-muted">{{ $business->registration_date }}</span>
                            </p>
                            <p class="border-bottom border-1 text-dark mb-2 font-16"><strong>नविकरण दस्तुर रसिद मिति
                                    :</strong>
                                <span class="ms-2 text-muted">{{ $business->registration_date }}</span>
                            </p>
                        </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    <td>१</td>
                                    <td>व्यवसाय दर्ता</td>
                                    <td> <a href="#" class="btn btn-xs btn-outline-warning" title="हेर्नुहोस्">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                        <a href="#" class="btn btn-xs btn-outline-warning" title="डाउनलोड गर्नुहोस">
