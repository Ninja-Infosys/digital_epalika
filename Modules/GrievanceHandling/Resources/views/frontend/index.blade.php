            ...
            <div class="col-md-12 mt-3">
                <div class="row">
                                ...
                                <div class="  d-flex justify-content-between align-items-center gap-3">
                                    ...
                                    <div class="info text-left w-75">
                                        ...
                                        <a href="{{route('grievanceHandling.grievance-register')}}"
                                            class="btn btn-primary btn-sm"><span>गुनासो
                                                दर्ता</span>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="card-body  d-flex justify-content-between align-items-center gap-3">
                                ...
                                <div class="info text-left w-75">
                                    ...
                                    <a href="{{route('grievanceHandling.policy')}}"
                                        class="btn btn-primary btn-sm"><span>नीतिहरु</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3 p-2">
                        <div class="card custom-card text-left">
                            <div class="card-body  d-flex justify-content-between align-items-center gap-3">
                                <img class="icon" style="width: 40px" src="{{asset('assets/frontend/image/new-icons/self-control.png')}}"
                                    alt="">
                                <div class="info text-left w-75">
                                    ...
                                    <a href="{{route('grievanceHandling.track')}}" class="btn btn-primary btn-sm"><span>गुनासो
                                            ट्र्याक</span>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="col-md-3 p-2">
                        <div class="card custom-card text-left">
                            <div class="card-body  d-flex justify-content-between align-items-center gap-3">
                                <img class="icon" style="width: 40px" src="{{asset('assets/frontend/image/new-icons/password.png')}}"
                                    alt="">
                                <div class="info text-left w-75">
                                    <h5 class="mt-0 mb-1 card-title text-left">गुनासो लग इन</h5>
                                    <h6 class="card-text mt-2 text-left">गुनासो/उजुरी लग इन ।</h6>
                                    <a href="" class="btn btn-primary btn-sm"><span>लग
                                            इन</span>
                                    </a>
                                </div>
                            </div>
                    ...
                    <!-- <div class="col-md-6 p-2">
                        <div class="card shadow text-center">
                            <div class="card-body">
                                ...
                                <a href="" class="btn btn-primary btn-sm"><span>लग इन</span>
