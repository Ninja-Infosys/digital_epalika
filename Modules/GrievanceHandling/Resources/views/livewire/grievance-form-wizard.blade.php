<div class="card">
    ...
    <div class="col-md-12 mb-4">
        ...
        <div class="d-flex">
            <div class="form-check" style="margin-right:15px">
                <input type="radio" class="form-check-input" name="is_open" wire:model="form.is_open" value="1"
                    id="is_open1">
                <label class="form-check-label" for="is_open1">हुन्छ | &nbsp;</label>
            </div>
            <div class="form-check" style="margin-right:15px">
                <input type="radio" class="form-check-input" name="is_open" wire:model="form.is_open" value="0"
                    id="is_open">
...
<div class="row mb-4">
    ...
    <div class="col-md-3">
        <div class="card">
            <div class="card-body">
                <img src="{{ $file->temporaryUrl() }}" style="width: 100%;height: auto;object-fit: contain" alt="File">
            </div>
        </div>
    </div>
    @endforeach
...
<div class="row">
    <div class="col-md-12 mb-4">
        ...
        <select name="grievance_type_id" wire:model="form.grievance_type_id" id="grievance_type_id" class="form-select">
    ...
    <div class="col-md-12 mb-4">
        ...
        <input type="text" class="form-control" id="subject" wire:model="form.subject" placeholder="बिषय">
        @error('form.subject')
        <div class="text-danger p-1">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="col-md-12 mb-4">
        ...
        <input type="file" name="files[]" multiple wire:model="form.files" id="files" class="form-control">
        @error('form.files')
        <div class="text-danger p-1">{{ $message }}</div>
        @enderror
        @error('form.files.*')
    ...
    <div class="col-md-12 mb-4">
        ...
        <div class="d-flex">
            ...
            <div class="form-check" style="margin-right:15px">
                ...
                <label class="form-check-label" for="complaint_severity{{ $severity->name }}">{{ $severity->label() }}
                    &nbsp;</label>
            </div>
            @endforeach
        </div>
