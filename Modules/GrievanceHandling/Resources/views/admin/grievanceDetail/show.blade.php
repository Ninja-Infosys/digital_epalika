            ...
            <div class="card-body px-0 text-dark">
                        ...
                        <form class="form-inline"
                            ...
                            <div class="row my-3">
                                ...
                                <div class="col-md-7 d-flex">
                                    ...
                                    <button type="submit" class="btn btn-sm btn-outline-primary mx-2 px-1">Save</button>
                                </div>
                            </div>
                        ...
                        <div class="row my-3">
                            ...
                            <div class="col-md-7">
                                <a href="{{ route('admin.grievanceHandling.grievanceDetail.approve', $grievanceDetail) }}"
                                    @class([ 'mx-0' , 'px-1' , 'text-white' , 'btn btn-sm' , 'bg-success'=>
                                    $grievanceDetail->is_approved == 1,
                                    'btn-danger' => $grievanceDetail->is_approved == 0,
                                    ])><i @class([ 'fa' , 'fa-check'=> $grievanceDetail->is_approved == 1,
                        ...
                        <div class="row my-3">
                            ...
                            <div class="col-md-7">
                                <a href="{{ route('admin.grievanceHandling.grievance-detail.show-to-public', $grievanceDetail) }}"
                                    @class([ 'mx-0' , 'px-1' , 'text-white' , 'btn btn-sm' , 'bg-success'=>
                                    $grievanceDetail->is_public == 1,
                                    'btn-danger' => $grievanceDetail->is_public == 0,
                                    ])><i @class([ 'fa' , 'fa-check'=> $grievanceDetail->is_public == 1,
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size: 13px;">
                                            <x-ad-to-bs id="assigned_at{{ $loop->iteration }}"
                ...
                <div class="col-md-4">
                    <h4 class="mt-3"><b>दर्ता स्थिति:</b> <a
                            ...
                            @class([ 'mx-2' , 'px-3' , 'text-white' , 'btn btn-sm' , 'bg-success'=>
                            $grievanceDetail->is_approved == 1,
                ...
                <div class="row">
                    ...
                    <div class="dropdown dropup gunaso-message">
                        <button class="btn bg-grey btn-box border-1 border-grey dropdown-toggle shadow" type="button" data-bs-toggle="dropdown"
                            aria-expanded="false">
                                    ...
                                    <form enctype="multipart/form-data"
                                        ...
                                        <div class="d-flex justify-content-start align-items-center p-2"
                                            ...
                                            <div class="flex-shrink-0 text-center d-flex align-items-center gap-2">
                                                ...
                                                <button type="submit" class="btn bg-grey text-dark h-100" style="height: 49px !important;
    width: 50px;" href="#"><i class="fas fa-paper-plane"></i></button>
                                            </div>
                                        </div>
                                    </form>
                                    @error('files.*')
