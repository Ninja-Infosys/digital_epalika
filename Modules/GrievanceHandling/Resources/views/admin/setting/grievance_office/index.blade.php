                            ...
                            @forelse($grievanceOffices as $grievanceOffice)
                                <tr>
                                    ...
                                    <td class="d-flex gap-1">
                                        <a data-bs-type="edit"
                                        href="{{ route('admin.grievanceHandling.setting.grievanceOffice.edit', $grievanceOffice) }}"
                                        class="btn btn-xs btn-outline-warning {{ get_setting('Pin') ? 'confirm_pin' : '' }}">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <form
                                    action="{{ route('admin.grievanceHandling.setting.grievanceOffice.destroy', $grievanceOffice) }}"
                                    method="post">
                                    @csrf
                                    @method('delete')
