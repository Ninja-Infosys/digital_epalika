            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">शाखा/कार्यालय सम्पादन गर्नुहोस</li>
                    </ol>
                </div>
                <h4 class="page-title">शाखा/कार्यालय सम्पादन गर्नुहोस </h4>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h4 class="header-title">शाखा/कार्यालय सम्पादन गर्नुहोस</h4>
                ...
                <div class="card-body">
                    <form action="{{route('admin.grievanceHandling.setting.grievanceOffice.update',$grievanceOffice)}}" method="post"
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-2">
                                    ...
                                    <input
                                        type="text"
                                        name="title"
                                        value="{{old('title',$grievanceOffice->title)}}"
