    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('admin.helpDesk.service.serviceEmployee.store',$service)}}" method="post"
                        ...
                        <table class="table table-sm mb-0 table-striped table-hover">
                            ...
                            @forelse($service->serviceEmployees as $key=>$serviceEmployee)
                                <tr>
                                    ...
                                    <td>
                                        <a data-bs-type="edit" href="{{route('admin.helpDesk.service.serviceEmployee.edit',[$service,$serviceEmployee])}}"
                                           class="btn btn-xs btn-outline-warning {{get_setting('Pin')?'confirm_pin':''}}">
                                            <i class="fa fa-edit"></i> सम्पादन गर्नुहोस्
                                        </a>
                                        <form
                                            action="{{route('admin.helpDesk.service.serviceEmployee.destroy',[$service,$serviceEmployee])}}"
                                            method="post">
                                            @csrf
                                            @method('delete')
