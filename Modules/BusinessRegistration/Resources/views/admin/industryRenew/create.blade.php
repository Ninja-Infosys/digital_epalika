            ...
            <div class="card p-0">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.businessRegistration.industry.industryRenew.index', $industry) }}"
                ...
                <div class="card-body px-0">
                    <form
                        action="{{ route('admin.businessRegistration.industry.industryRenew.store', $industry) }}"
