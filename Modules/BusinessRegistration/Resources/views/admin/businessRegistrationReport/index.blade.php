                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-2">
                                            ...
                                            <select name="business_nature[]" multiple data-toggle="select2"
                                                    id="business_nature"
                                                    class="form-control">
                                                <option value="" disabled> --व्यवसाय प्रकृति अनुसार--</option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-2">
                                            ...
                                            <select name="registration_renewal[]" id="registration_renewal" multiple
                                                    data-toggle="select2"
                                                    class="form-control">
                                                <option value="" disabled> --दर्ता र नविकरण अनुसार--</option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-2">
                                            ...
                                            <select name="business_purpose[]" multiple data-toggle="select2"
                                                ...
                                                <option value="" disabled> --उदेश्य अनुसार--</option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-2">
                                            ...
                                            <select name="object_transaction[]"
                                                ...
                                                <option value="" disabled> --कारोबार वस्तु--</option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-2">
                                            ...
                                            <select name="investment_revenue[]" id="investment_revenue" multiple
                                                    data-toggle="select2"
                                                    class="form-control">
                                                <option value="" disabled> --पुँजीगत लगानी र राजस्वो--</option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-2">
                                            ...
                                            <select name="business_year[]" id="business_year" multiple
                                                    data-toggle="select2"
                                                    class="form-control">
                                                <option value="" disabled> --साल--</option>
                                                @foreach($businessYears as $year)
                                                    <option value="{{$year}}">{{$year}}</option>
                                                @endforeach
                                            </select>
