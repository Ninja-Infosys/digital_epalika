            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="{{route('admin.businessRegistration.forum.forumRenew.index',$forum)}}" class="btn btn-sm btn-outline-primary">
                            <i class="fa fa-list"></i> नवीकरण सूची
                        </a>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{route('admin.businessRegistration.forum.forumRenew.update',[$forum,$forumRenew])}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        @if ($errors->any())
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                <x-date-input-component
                                    ...
                                    :edit-date-ne="$forumRenew->date"
                                    :edit-date-en="$forumRenew->date_en"
                                />
                            </div>
                            <div class="col-md-6 mb-2">
                                <x-date-input-component
                                    ...
                                    :edit-date-ne="$forumRenew->date_to_be_maintained"
                                    :edit-date-en="$forumRenew->date_to_be_maintained_en"
                                />
                            </div>
                            <div class="col-md-6 mb-2">
                                ...
                                <input
                                    ...
                                    step="any"
                                    name="renew_amount"
                                    value="{{old('renew_amount',$forumRenew->renew_amount)}}"
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input
                                    ...
                                    step="any"
                                    name="penalty_amount"
                                    value="{{old('penalty_amount',$forumRenew->penalty_amount)}}"
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input
                                    ...
                                    value="{{old('payment_receipt',$forumRenew->payment_receipt)}}"
                            ...
                            <div class="col-md-6 mb-2">
                                <x-date-input-component
                                    ...
                                    :edit-date-ne="$forumRenew->payment_receipt_date"
                                    :edit-date-en="$forumRenew->payment_receipt_date_en"
                                />
                            </div>
