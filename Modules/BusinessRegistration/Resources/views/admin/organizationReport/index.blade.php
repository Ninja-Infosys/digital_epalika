            ...
            <div class="card p-0">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex gap-1 justify-content-between">
                            ...
                            <x-html-to-excel file-name="संस्था रिपोर्ट" target-table="organization-report-table" />
                            <x-print-button target-element="organization-report-table" title="संस्था रिपोर्ट" :headerRequired="true" />
                        </div>
                    </div>
                </div>
                <div class="card-body px-0">
                        ...
                        <form id="report-filter-form"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" placeholder="संस्थाको नाम">
                                </div>
                    ...
                    <div class="table-responsive">
                        <div id="organization-report-table"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    @push('scripts')
        <script>
            function createTable(headerData, bodyData) {
                const tableDiv = document.getElementById("organization-report-table");
                tableDiv.innerHTML = "";
