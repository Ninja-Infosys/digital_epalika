                ...
                @foreach ($form['committeeNames'] as $key => $partner)
                            ...
                            <div class="col-md-4 mb-1">
                                ...
                                <div class="input-group">
                                    <input
                                        ...
                                        wire:model="form.committeeNames.{{ $key }}.name_en"
                            ...
                            <div class="col-md-3 mb-1">
                                ...
                                <div class="input-group">
                                    <input
                                        ...
                                        wire:model="form.committeeNames.{{ $key }}.issue_date"
                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-1">
                                <label for="form.committeeNames.{{ $key }}.tole"
                                    class="form-label">गाउँ/टोल</label>
                ...
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-2 pr-0">
                            <div class="row input-group">
                                <div class="col-md-6 pr-0">
                                    <label for="phone" class="form-label">सम्पर्क नं<span
                                            class="text-danger">*</span></label>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row input-group">
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control @error('form.investment') is-invalid @enderror"
                                            type="text" step="any" id="investment" wire:model="form.investment"
                                            placeholder="कूल पूँजी">
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control @error('form.fixed_capital') is-invalid @enderror"
                                            type="text" step="any" id="fixed_capital" wire:model="form.fixed_capital"
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control @error('form.electricity') is-invalid @enderror"
                                            type="text" step="any" id="electricity" wire:model="form.electricity"
                                            placeholder="आवश्यक विधुत शक्ति">
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control @error('form.manpower') is-invalid @enderror"
                                            type="text" step="any" id="manpower" wire:model="form.manpower"
                                            placeholder="आवश्यक पर्ने जनशक्ति">
                                        @error('form.manpower')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control @error('form.open_date') is-invalid @enderror"
                                            type="text" step="any" id="open_date" wire:model="form.open_date"
                                            placeholder="उधोग संचालन हुने सिफ़ट संख्या">
                                ...
                                <div class="col-md-12 mb-2">
                                    <label for="start_date" class="form-label">उधोग संचालन, व्यावसायिक उत्पादन वा कारोवार सुरु
                                        गर्नेपर्ने अवधि</label>
                                    <div class="input-group">
                                        <input class="form-control @error('form.start_date') is-invalid @enderror"
                                            type="text" step="any" id="start_date" wire:model="form.start_date"
                                            placeholder="उधोग संचालन, व्यावसायिक उत्पादन वा कारोवार सुरु गर्नेपर्ने अवधि">
                                ...
                                <div class="col-md-6 mb-2">
                                    <label for="product" class="form-label">उधोगले उत्पादन गर्ने वस्तु वा सेवाको
                                        प्रकार</label>
                                    <div class="input-group">
                                        <input class="form-control @error('form.product') is-invalid @enderror"
                                            type="text" step="any" id="product" wire:model="form.product"
                                            placeholder="उधोगले उत्पादन गर्ने वस्तु वा सेवाको प्रकार">
                                        @error('form.product')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control @error('form.other') is-invalid @enderror" type="text"
                                            step="any" id="other" wire:model="form.other" placeholder="अन्य">
                                        @error('form.other')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control @error('form.working_days') is-invalid @enderror"
                                            type="text" step="any" id="working_days" wire:model="form.working_days"
                                            placeholder="उधोग संचालन दिन (प्रति वर्ष)">
