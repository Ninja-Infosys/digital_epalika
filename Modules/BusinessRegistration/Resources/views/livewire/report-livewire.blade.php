                            ...
                            <div class="row">
                                <div class="col-md-12 mb-2">
                                    ...
                                    <select name="business_nature" multiple data-toggle="select2"
                                            wire:model="form.business_nature" id="business_nature" class="form-control">
                        ...
                        <fieldset class="border p-2 mb-2">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-2">
                                    ...
                                    <select name="business_purpose" multiple data-toggle="select2" wire:model="form.business_purpose"
                        ...
                        <fieldset class="border p-2 mb-2">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-2">
                                    ...
                                    <select name="object_transaction" wire:model="form.object_transaction" multiple data-toggle="select2" id="object_transaction" class="form-control" >
                        ...
                        <fieldset class="border p-2 mb-2">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-2">
                                    ...
                                    <select name="investment_revenue" id="investment_revenue" multiple data-toggle="select2" wire:model="form.investment_revenue" class="form-control" >
                        ...
                        <fieldset class="border p-2 mb-2">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-2">
                                    ...
                                    <select name="registration_renewal" id="registration_renewal" multiple data-toggle="select2" wire:model="form.registration_renewal" class="form-control" >
