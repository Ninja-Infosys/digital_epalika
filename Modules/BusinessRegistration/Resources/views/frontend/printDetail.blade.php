    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class=" row font-black">
                ...
                <div class="col-md-3">
                    <p>व्यबसायीको स्थायी
                        ठेगाना : <span class="underline-dotted">{{$proprietorDetail->province->province??''}}, {{$proprietorDetail->district->district??''}} जिल्ला </span>
                    </p>
                </div>
                <div class="col-md-3">
                    <p> नगरपालिका : <span
                ...
                <div class="col-md-3">
                    <p> नगरपालिका : <span
                            class="underline-dotted"> {{$proprietorDetail->businessDetail->localBody->local_body??''}}</span>
                    </p>
                </div>
                <div class="col-md-3">
                    <p> वडा नं. : <span
                            class="underline-dotted">{{$proprietorDetail->businessDetail->ward_no??''}}</span></p>
                </div>
                <div class="col-md-3">
                    <p>मार्ग : <span
                            class="underline-dotted"> {{$proprietorDetail->businessDetail->ward_no??''}} </span></p>
                ...
                @if($proprietorDetail->businessDetail->is_rent==1)
                    ...
                    <div class="col-md-3">
                        <p> घर जग्गा धनीको नाम, थर:
                            <span
                                class="underline-dotted">{{$proprietorDetail->businessDetail->house_owner_name??''}} </span>
                        </p>
                    </div>
                    <div class="col-md-3">
                        <p>घर जग्गा धनीको
                ...
                <div class="col-md-12">
                    <p class="text-center my-3" style="text-align: center; margin-top: 10px;"><b>संलग्न कागजातहरु</b>
                    </p>
                </div>
