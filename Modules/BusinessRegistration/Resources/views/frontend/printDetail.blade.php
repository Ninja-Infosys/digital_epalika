    ...
    <section class="row justify-content-center my-4 ">
        <div class="card col-md-8 border">
            <div class="card-body">
                ...
                <x-print-button target-element="printData" title="{{ $businessDetail->name }}" />
                <div id="printData">
                    <p>
                    ...
                    <p> २. स्थायी ठेगाना : <span
                        ...
                        पा.
                        वडा नं <span
                            class="dashed-bottom">{{ $businessDetail->partners->first()?->ward_no ?? '' }}</span>
                        <span class="dashed-bottom">{{ $businessDetail->partners->first()?->way ?? '' }}</span> मार्ग घर
                        नं.
                    ...
                    <p> ५. व्यवसाय रहने स्थानको ठेगाना : <span
                        ...
                        <span class="dashed-bottom">{{ $businessDetail->localBody->local_body ?? '' }}</span> गा . पा. /
                        न. पा.
                    ...
                    <p> ६. सम्पर्क फोन नं : <span
                        ...
                        <span class="dashed-bottom">{{ $businessDetail->partners->first()?->email ?? '' }}</span>
                    </p>

                    <p> ७. भाडामा भएको भए व्यवसाय रहने घर र जग्गा धनीको नाम, थर :
                        <span class="dashed-bottom">{{ $businessDetail->house_owner_name }}</span>
                    </p>
                    ...
                    <p>११. परिचय पाटीको साइज : <span class="dashed-bottom">{{ $businessDetail->length }}</span> *
                        <span class="dashed-bottom">{{ $businessDetail->width }}</span> Sq.ft
                    </p>
                    <div class="d-flex" style="justify-content: space-between;">
                        ...
                        <div>
                            <p class="dashed text-center">व्यवसायीधनिको सही
                                <br>
                                प्रोपराईटर : {{ $businessDetail->partners->first()?->name ?? '' }}
                            </p>
