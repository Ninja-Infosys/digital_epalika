...
<div class="font-black" id="printData">
        ...
        <div class="col-md-6">
            <x-header-component/>
            <p style="text-align: center;">व्यवसाय दर्ता/नवीकरण निवेदन
                फाराम</p>
        </div>
        <div class="col-md-3">
    ...
    <div class="col-md-12">
        <p class="text-center my-3" style="text-align: center;"><b> विषय:- व्यवसाय दर्ता/सम्बन्धमा ।</b></p>
    </div>
    <div class="col-md-12">
        <p class="mb-3">
    ...
    <div class="col-md-3">
        <p>व्यबसायीको स्थायी
            ठेगाना : <span class="underline-dotted">{{$proprietorDetail->province->province??''}}, {{$proprietorDetail->district->district??''}} जिल्ला </span></p>
    </div>
    <div class="col-md-3">
        <p> नगरपालिका : <span class="underline-dotted">{{$proprietorDetail->localBody->local_body??''}}</span></p>
    </div>
    <div class="col-md-3">
    ...
    <div class="col-md-12">
        <p> व्यवसाय रहने स्थानको
            ठेगाना : <span class="underline-dotted">{{$proprietorDetail->businessDetail->province->province??''}} , {{$proprietorDetail->businessDetail->district->district??''}} जिल्ला</span>
        </p>
    </div>
    <div class="col-md-3">
        <p> नगरपालिका : <span
                class="underline-dotted"> {{$proprietorDetail->businessDetail->localBody->local_body??''}}</span></p>
    </div>
    <div class="col-md-3">
        <p> वडा नं. : <span class="underline-dotted">{{$proprietorDetail->businessDetail->ward_no??''}}</span></p>
    </div>
    <div class="col-md-3">
        <p>मार्ग : <span class="underline-dotted"> {{$proprietorDetail->businessDetail->ward_no??''}} </span></p>
    </div>
    ...
    @if($proprietorDetail->businessDetail->is_rent==1)
        ...
        <div class="col-md-3">
            <p> घर जग्गा धनीको नाम, थर:
                <span class="underline-dotted">{{$proprietorDetail->businessDetail->house_owner_name??''}} </span></p>
        </div>
        <div class="col-md-3">
            <p>घर जग्गा धनीको
                ठेगाना: <span
                    class="underline-dotted">{{$proprietorDetail->businessDetail->house_owner_address??''}} </span>
            </p>
        </div>
        <div class="col-md-3">
            <p>घर जग्गा धनीको
                मोबाइल.: <span
                    class="underline-dotted">{{$proprietorDetail->businessDetail->house_owner_phone??''}} </span>
            </p>
        </div>
        <div class="col-md-3">
            <p> घर जग्गा धनीको मासिक भाडा
                रु.: <span
                    class="underline-dotted">{{$proprietorDetail->businessDetail->house_owner_monthly_rent??''}} </span>
            </p>
        </div>
    @endif
    ...
    <div class="col-md-3">
        <p>पूँजी लगानी रु. : <span
                class="underline-dotted">{{$proprietorDetail->businessDetail->amount_cost??''}}</span></p>
    </div>
    <div class="col-md-6">
        <p>फर्म-कम्पनीको नाम : <span
                class="underline-dotted">{{$proprietorDetail->businessDetail->business_detail_name ??''}}</span></p>
    </div>
    <div class="col-md-6">
        <p>परिचय पाटीको साइज: (लम्बाई <span
                class="underline-dotted">{{$proprietorDetail->introboard->length??''}}</span>
            चौडाई <span class="underline-dotted">{{$proprietorDetail->introboard->width??''}}</span>वर्गफिट
            <span class="underline-dotted">{{$proprietorDetail->introboard->square??''}}</span>)</p>
    </div>


    @if($proprietorDetail->businessDetail->is_registered==1)
        <div class="col-md-12">
            <p class="text-center my-3" style="text-align: center;"><b>अन्यत्र दर्ता भएको दर्ता नं </b></p>
            <div>
                <table>
                    <tr>
                        <th>दर्ता नम्बर</th>
    ...
    <div class="col-md-12">
        <p class="text-center my-3" style="text-align: center; margin-top: 10px;"><b>संलग्न कागजातहरु</b></p>
    </div>
