...
return new class () extends Migration {
    public function up()
    {
        Schema::create('business_details', function (Blueprint $table) {
            ...
            $table->foreignId('business_nature_id')->nullable()->constrained()->comment('व्यवसायको प्रकृति')->nullOnDelete()->onUpdate('no action');
            $table->foreignId('object_transaction_id')->nullable()->constrained()->comment('व्यवसायको कारोबार गर्ने मुख्य सेवा वा बस्तु')->nullOnDelete()->onUpdate('no action');
