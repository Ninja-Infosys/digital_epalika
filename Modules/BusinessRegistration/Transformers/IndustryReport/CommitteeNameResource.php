...
class CommitteeNameResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'समितिको ठेगाना ' => $this->when((bool)array_intersect(['province_id', 'district_id', 'local_body_id', 'ward_no', 'tole','way'], $request_columns), function () use ($request_columns) {
