...
Route::get('seniorCitizenshipDetail/{seniorCitizenshipDetail}/qrcode',[FrontController::class,'seniorCitizenshipDetailQrcode'])->name('seniorCitizenshipDetail.qrcode');
