    ...
    <div class="row mb-3">
      <div class="col-md-4">
        <VMultiSelect
          ...
          :options="eBuildingSetting?.organizations ?? []"
        ...
        <div class="row">
          <div class="col-md-3 mb-3">
            <VInput
              ...
              placeholder="भवनको प्लिथको क्षेत्रफल"
              label="१.१ भवनको प्लिथको क्षेत्रफल"
          ...
          <div class="col-md-3 mb-3">
            <VInput
              ...
              placeholder="घर बनेको साल"
              label="१.४ घर बनेको साल"
    ...
    <div class="card p-4 mb-4">
      ...
      <div class="row">
        <div class="col-md-4 mb-3">
          <VInput
            id="landowner-name"
            v-model="form.buildingLandOwner.name"
            label="जग्गा धनीको नाम"
            @validate="validateField('buildingLandOwner.name')"
            :error="errors['buildingLandOwner.name']"
          />
        </div>
        <div class="col-md-4 mb-3">
          <VInput
            id="landowner-phone"
            v-model="form.buildingLandOwner.phone"
            label="फोन नं."
        ...
        <div class="col-md-4 mb-3">
          <VInput
            ...
            v-model="form.buildingLandOwner.citizenship_no"
            label="नागरिकता नम्बर"
            @validate="validateField('buildingLandOwner.citizenship_no')"
        ...
        <div class="col-md-4 mb-3">
          <VNepaliDatePicker
            ...
            v-model="form.buildingLandOwner.citizenship_issue_date"
            label="नागरिकता लिएको मिति"
            @validate="validateField('buildingLandOwner.citizenship_issue_date')"
        ...
        <div class="col-md-4 mb-3">
          <VMultiSelect
            ...
            @validate="validateField('buildingLandOwner.citizenship_issue_district_id')"
        ...
        <div class="col-md-4 mb-3">
          <VInput
            ...
            v-model="form.buildingLandOwner.father_name"
            label="बुवाको नाम"
        ...
        <div class="col-md-4 mb-3">
          <VInput
            ...
            v-model="form.buildingLandOwner.grandfather_name"
            label="हजुरबुबाको नाम"
            @validate="validateField('buildingLandOwner.grandfather_name')"
        ...
        <div class="col-md-4 mb-3">
          <VFileUpload
            id="landowner-photo"
            v-model="form.buildingLandOwner.photo"
            ...
            <div class="row">
              <div class="col-md-4 mb-3">
                <VMultiSelect
                  ...
                  v-model="form.buildingLandOwner.province_id"
                  :options="buildingLandOwnerProvinces ?? []"
                  name-prop="province"
                  label="प्रदेश"
                  @validate="validateField('buildingLandOwner.province_id')"
              ...
              <div class="col-md-4 mb-3">
                <VMultiSelect
                  ...
                  v-model="form.buildingLandOwner.district_id"
                  :options="buildingLandOwnerDistricts ?? []"
                  name-prop="district"
                  label="जिल्ला"
                  @validate="validateField('buildingLandOwner.district_id')"
              ...
              <div class="col-md-4 mb-3">
                <VMultiSelect
                  ...
                  label="पालिका"
                  @validate="validateField('buildingLandOwner.local_body_id')"
              ...
              <div class="col-md-4 mb-3">
                <VMultiSelect
                  ...
                  v-model="form.buildingLandOwner.ward_no"
                  :options="buildingLandOwnerWards ?? []"
                  label="वार्ड"
                  @validate="validateField('buildingLandOwner.ward_no')"
              ...
              <div class="col-md-3 mb-3">
                <VInput
                  input-type="text"
                  id="tole"
                  v-model="form.buildingLandOwner.tole"
                  placeholder="टोल"
                  label="टोल"
                  @validate="validateField('buildingLandOwner.tole')"
    ...
    <div class="card p-4 mb-4">
      ...
      <div class="row">
        <div class="col-md-4 mb-3">
          <VInput
            id="houseOwner-name"
            v-model="form.buildingHouseOwner.name"
            label="घर धनीको नाम"
        ...
        <div class="col-md-4 mb-3">
          <VInput
            id="houseOwner-phone"
            v-model="form.buildingHouseOwner.phone"
            label="फोन नं."
            :disabled="building_house_owner_as_building_land_owner"
        ...
        <div class="col-md-4 mb-3">
          <VInput
            ...
            v-model="form.buildingHouseOwner.citizenship_no"
            label="नागरिकता नम्बर"
            :disabled="building_house_owner_as_building_land_owner"
        ...
        <div class="col-md-4 mb-3">
          <VNepaliDatePicker
            ...
            v-model="form.buildingHouseOwner.citizenship_issue_date"
            label="नागरिकता लिएको मिति"
            :disabled="building_house_owner_as_building_land_owner"
            @validate="validateField('buildingHouseOwner.citizenship_issue_date')"
        ...
        <div class="col-md-4 mb-3">
          <VMultiSelect
            ...
            label="नागरिकता लिएको जिल्ला"
            :disabled="building_house_owner_as_building_land_owner"
            @validate="validateField('buildingHouseOwner.citizenship_issue_district_id')"
        ...
        <div class="col-md-4 mb-3">
          <VInput
            ...
            v-model="form.buildingHouseOwner.father_name"
            label="बुवाको नाम"
            :disabled="building_house_owner_as_building_land_owner"
        ...
        <div class="col-md-4 mb-3">
          <VInput
            ...
            v-model="form.buildingHouseOwner.grandfather_name"
            label="हजुरबुबाको नाम"
            :disabled="building_house_owner_as_building_land_owner"
        ...
        <div class="col-md-4 mb-3">
          <VFileUpload
            id="houseowner-photo"
            v-model="form.buildingHouseOwner.photo"
            label="घर धनीको फोटो"
            :show-preview-image="false"
          />
        </div>
            ...
            <div class="row">
              ...
              <div class="col-md-3 mb-3">
                <VInput
                  input-type="text"
                  id="tole"
                  v-model="form.buildingHouseOwner.tole"
                  placeholder="टोल"
                  label="टोल"
                  @validate="validateField('buildingHouseOwner.tole')"
