<template>
    <form @submit.prevent="registerBuildingApplication">
        ...
        <div class="card p-4 mb-4">
            ...
            <div class="mb-1">
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        <VInput input-type="number" id="current_storey" v-model="form.current_storey"
                            placeholder="तल्ला संख्या" label="१.३ तल्ला संख्या"
                            @validate="validateField('current_storey')" :error="errors.current_storey" />
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    <VInput input-type="text" v-model="form.former_local_body" label="२.२ साविक पालिका"
                        placeholder="साविक पालिका" @validate="validateField('former_local_body')"
                ...
                <div class="col-md-4 mb-3">
                    <VInput input-type="number" id="plot_no" v-model="form.plot_no" label="२.४ जग्गा कित्ता नं"
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    <VNepaliDatePicker id="landowner-citizenship_issue_date"
                        v-model="form.buildingLandOwner.citizenship_issue_date" label="नागरिकता लिएको मिति"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                <VMultiSelect id="landOwner-ward_no" v-model="form.buildingLandOwner.ward_no"
                                    :options="buildingLandOwnerWards ?? []" label="वार्ड"
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    <VMultiSelect id="houseOwner-citizenship_issue_district_id"
                        ...
                        :options="eBuildingSetting?.allDistricts ?? []" name-prop="district"
                        label="नागरिकता लिएको जिल्ला" :disabled="building_house_owner_as_building_land_owner"
        ...
        <div class="card p-4 mb-4">
            ...
            <div class="mb-3">
                ...
                <div class="col">
                    <div v-for="type in eBuildingSetting?.applicantTypes ?? []" class="form-check form-check-inline">
                        <input type="radio" :id="type.value" v-model="form.applicant_type" :value="type.value"
                            @change="validateField('applicant_type')" class="form-check-input" />
            ...
            <div class="col-md-12">
                <fieldset>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <VMultiSelect id="province_id" v-model="form.province_id"
                                :options="applicantDetailProvinces ?? []" name-prop="province" label="प्रदेश"
                                :disabled="isApplicantSame" @validate="validateField('province_id')"
                                :error="errors['province_id']" />
                        </div>
                        <div class="col-md-4 mb-3">
                            <VMultiSelect id="district_id" v-model="form.district_id"
                                :options="applicantDetailDistricts ?? []" name-prop="district" label="जिल्ला"
                                :disabled="isApplicantSame" @validate="validateField('district_id')"
                                :error="errors['district_id']" />
                        </div>
                        <div class="col-md-4 mb-3">
                            <VMultiSelect id="local_body_id" v-model="form.local_body_id"
                                :options="applicantDetailLocalBodies ?? []" name-prop="local_body" label="पालिका"
                                :disabled="isApplicantSame" @validate="validateField('local_body_id')"
                                :error="errors['local_body_id']" />
                        </div>
                        <div class="col-md-4 mb-3">
                            <VMultiSelect id="ward_no" v-model="form.applicant_ward_no"
                                :options="applicantDetailWards ?? []" label="वार्ड" :disabled="isApplicantSame"
                                @validate="validateField('applicant_ward_no')" :error="errors['applicant_ward_no']" />
                        </div>

                        <div class="col-md-3 mb-3">
                            <VInput input-type="text" id="tole" v-model="form.applicant_tole" placeholder="टोल"
                                label="टोल" @validate="validateField('applicant_tole')"
        ...
        <div class="d-flex justify-content-between mt-3">
            <div class="col-3">
                <VNepaliDatePicker id="application_date" v-model="form.application_date" label="निवेदनको मिति"
                    @validate="validateField('application_date')" :error="errors['application_date']" />
            </div>
            <div class="col-md-4 mb-3">
                <VFileUpload id="applicant_signature" v-model="form.applicant_signature" label="निवेदकको सहि"
                    :show-preview-image="false" />
            </div>
