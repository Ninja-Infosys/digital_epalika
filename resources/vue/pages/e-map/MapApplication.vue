<template>
    <form @submit.prevent="registerApplication">
        ...
        <div class="card p-4 mb-4">
            ...
            <div class="mb-3">
                <label class="form-label fw-bolder"
                    >१.१ निर्माण कार्यको किसिम *</label
                >
                <div class="col">
                    <div
                        v-for="type in eMapSetting?.constructionTypes ?? []"
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    <VInput
                        ...
                        @validate="
                            validateField('landDetail.former_local_body')
                        "
                ...
                <div class="col-md-4 mb-3">
                    <VInput
                        ...
                        :label="`क्षेत्रफल (${
                            eMapSetting?.setting?.standard_land_measurement ??
                            ''
                        })`"
        ...
        <div class="card p-4 mb-4">
            ...
            <div class="mb-3">
                <label class="form-label fw-bolder"
                    >३.१ जग्गा धनीको किसिम
                    <span class="text-danger">*</span></label
                >
                <div class="col">
                    <div
                        v-for="ownerType in eMapSetting?.ownerTypes ?? []"
                        class="form-check form-check-inline"
                    >
                        <input
                            type="radio"
                        ...
                        />
                        <label class="form-check-label" :for="ownerType.value">
                            {{ ownerType.label }}
                        </label>
                    </div>
                </div>
                <p
                    v-if="errors['landOwner.land_owner_type']"
                    class="text-danger"
                >
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    <VNepaliDatePicker
                        ...
                        @validate="
                            validateField('landOwner.citizenship_issue_date')
                        "
                ...
                <div class="col-md-4 mb-3">
                    <VMultiSelect
                        ...
                        @validate="
                            validateField(
                                'landOwner.citizenship_issue_district_id'
                            )
                        "
                        :error="
                            errors['landOwner.citizenship_issue_district_id']
                        "
                    />
                </div>
                <div class="col-md-4 mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <VMultiSelect
                                    ...
                                    label="प्रदेश"
                                    @validate="
                                        validateField('landOwner.province_id')
                                    "
                            ...
                            <div class="col-md-4 mb-3">
                                <VMultiSelect
                                    ...
                                    label="जिल्ला"
                                    @validate="
                                        validateField('landOwner.district_id')
                                    "
                            ...
                            <div class="col-md-4 mb-3">
                                <VMultiSelect
                                    ...
                                    label="पालिका"
                                    @validate="
                                        validateField('landOwner.local_body_id')
                                    "
                            ...
                            <div class="col-md-4 mb-3">
                                <VMultiSelect
                                    ...
                                    label="वार्ड"
                                    @validate="
                                        validateField('landOwner.ward_no')
                                    "
        ...
        <div class="card p-4 mb-4">
            ...
            <div class="d-flex align-items-center gap-2 mb-3">
                <label for="detail_check"
                    >के घर धनीको विवरण र जग्गाधनीको विवरण एउटै हो ?</label
                >
                <button
                    type="button"
                    @click.prevent="
                        house_owner_as_land_owner = !house_owner_as_land_owner
                    "
                ...
                >
                    <i
                        :class="
                            'fa fa-2x fa-toggle-' +
                            (house_owner_as_land_owner ? 'on' : 'off')
                        "
                    ></i>
                </button>
            </div>
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    <VNepaliDatePicker
                        ...
                        :disabled="house_owner_as_land_owner"
                        @validate="
                            validateField('houseOwner.citizenship_issue_date')
                        "
                ...
                <div class="col-md-4 mb-3">
                    <VMultiSelect
                        ...
                        @validate="
                            validateField(
                                'houseOwner.citizenship_issue_district_id'
                            )
                        "
                        :error="
                            errors['houseOwner.citizenship_issue_district_id']
                        "
                    />
                </div>
                <div class="col-md-4 mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <VMultiSelect
                                    ...
                                    :disabled="house_owner_as_land_owner"
                                    @validate="
                                        validateField('houseOwner.province_id')
                                    "
                            ...
                            <div class="col-md-4 mb-3">
                                <VMultiSelect
                                    ...
                                    :disabled="house_owner_as_land_owner"
                                    @validate="
                                        validateField('houseOwner.district_id')
                                    "
                            ...
                            <div class="col-md-4 mb-3">
                                <VMultiSelect
                                    ...
                                    :disabled="house_owner_as_land_owner"
                                    @validate="
                                        validateField('houseOwner.ward_no')
                                    "
        ...
        <div class="card p-4 mb-4">
            ...
            <div class="mb-3">
                ...
                <div class="col">
                    ...
                    >
                        <input
                            ...
                            :value="type.value"
                            @change="
                                validateField('applicantDetail.applicant_type')
                            "
                            class="form-check-input"
                        />
                        <label class="form-check-label" :for="type.value">{{
                ...
                <p
                    v-if="errors['applicantDetail.applicant_type']"
                    class="text-danger"
                >
            ...
            <div class="mb-3">
                ...
                <p
                    v-if="errors['applicantDetail.relation_with_owner']"
                    class="text-danger"
                >
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    <VInput
                        ...
                        :disabled="isApplicantSame"
                        @validate="
                            validateField('applicantDetail.citizenship_no')
                        "
                ...
                <div class="col-md-4 mb-3">
                    <VNepaliDatePicker
                        ...
                        "
                        :error="
                            errors['applicantDetail.citizenship_issue_date']
                        "
                    />
                </div>
                <div class="col-md-4 mb-3">
                    <VMultiSelect
                        ...
                        @validate="
                            validateField(
                                'applicantDetail.citizenship_issue_district_id'
                            )
                        "
                        :error="
                            errors[
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <VMultiSelect
                                ...
                                v-model="form.applicantDetail.province_id"
                                :options="applicantDetailProvinces ?? []"
                                name-prop="province"
                                label="प्रदेश"
                                :disabled="isApplicantSame"
                                @validate="
                                    validateField('applicantDetail.province_id')
                                "
                                :error="errors['applicantDetail.province_id']"
                            />
                        </div>
                        <div class="col-md-4 mb-3">
                            <VMultiSelect
                                id="applicantDetail-district_id"
                                v-model="form.applicantDetail.district_id"
                                :options="applicantDetailDistricts ?? []"
                                name-prop="district"
                                label="जिल्ला"
                                :disabled="isApplicantSame"
                                @validate="
                                    validateField('applicantDetail.district_id')
                                "
                                :error="errors['applicantDetail.district_id']"
                            />
                        </div>
                        <div class="col-md-4 mb-3">
                            <VMultiSelect
                                id="applicantDetail-local_body_id"
                                v-model="form.applicantDetail.local_body_id"
                                ...
                                @validate="
                                    validateField(
                                        'applicantDetail.local_body_id'
                                    )
                                "
                                :error="errors['applicantDetail.local_body_id']"
                            />
                        </div>
                        <div class="col-md-4 mb-3">
                            <VMultiSelect
                                id="applicantDetail-ward_no"
                                v-model="form.applicantDetail.ward_no"
                                :options="applicantDetailWards ?? []"
                                label="वार्ड"
                                :disabled="isApplicantSame"
                                @validate="
                                    validateField('applicantDetail.ward_no')
                                "
                                :error="errors['applicantDetail.ward_no']"
                            />
                        </div>
                        ...
                        <div class="col-md-3 mb-3">
                            <VInput
                                input-type="text"
                                id="tole"
                                v-model="form.applicantDetail.tole"
                                placeholder="टोल"
                                label="टोल"
                                @validate="
                                    validateField('applicantDetail.tole')
                                "
                                :error="errors['applicantDetail.tole']"
                            />
                        </div>
                    </div>
                </fieldset>
        ...
        <div class="d-flex justify-content-between mt-3">
            <div class="col-3">
                <VNepaliDatePicker
                    ...
                    label="निबेदनको मिति"
                    @validate="
                        validateField('applicantDetail.application_date')
                    "
...
watch(
    () => house_owner_as_land_owner.value,
    () => {
...
const setLandOwnerToHouseOwner = () => {
    if (house_owner_as_land_owner.value) {
        ...
        form.houseOwner.citizenship_issue_date =
            form.landOwner.citizenship_issue_date;
        form.houseOwner.citizenship_issue_district_id =
            form.landOwner.citizenship_issue_district_id;
...
watch(
    () => form.applicantDetail.applicant_type,
    (type) => {
        if (type === "house owner") {
            ...
            form.applicantDetail.citizenship_issue_district_id =
                form.houseOwner.citizenship_issue_district_id;
            form.applicantDetail.province_id = form.houseOwner.province_id;
            form.applicantDetail.district_id = form.houseOwner.district_id;
            form.applicantDetail.local_body_id =
                form.houseOwner.local_body_id;
            form.applicantDetail.ward_no = form.houseOwner.ward_no;
            form.applicantDetail.tole = form.houseOwner.tole;
            ...
            form.applicantDetail.citizenship_issue_district_id =
                form.landOwner.citizenship_issue_district_id;
            form.applicantDetail.province_id = form.landOwner.province_id;
            form.applicantDetail.district_id = form.landOwner.district_id;
            form.applicantDetail.local_body_id =
                form.landOwner.local_body_id;
            form.applicantDetail.ward_no = form.landOwner.ward_no;
            form.applicantDetail.tole = form.landOwner.tole;
        } else {
            ...
            form.applicantDetail.citizenship_issue_date = "";
            form.applicantDetail.citizenship_issue_district_id = "";
            form.applicantDetail.province_id = "";
            form.applicantDetail.district_id = "";
            form.applicantDetail.local_body_id = "";
            form.applicantDetail.ward_no = "";
            form.applicantDetail.tole = "";
        }
    }
);
...
const validations = object({
    ...
    landOwner: object().shape({
        ...
        citizenship_issue_date: string().required(
            "नागरिकता लिएको मिति अनिवार्य छ"
        ),
