                        ...
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                ...
                                <textarea name="header"
                                          id="header"
                                          cols="30" rows="10"
                                          class="form-control ckEditor @error('header') is-invalid @enderror">{{old('header',$role->letterHead->header??'')}}</textarea>
                                @error('header')
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <textarea name="letter_head"
                                          id="letter_head"
                                          cols="30" rows="10"
                                          class="form-control ckEditor @error('letter_head') is-invalid @enderror">{{old('letter_head',$role->letterHead->letter_head??'')}}</textarea>
                                @error('letter_head')
                                <div class="invalid-feedback">{{$message}}</div>
                                @enderror
                            </div>
