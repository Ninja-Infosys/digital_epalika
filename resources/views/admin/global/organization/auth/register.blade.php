                        ...
                        <div class="title">
                            <div class="m-2">
                                @foreach ($officeheaders as $header)
                                    @if ($loop->first)
                                        <h2 class="text-primary fw-bolder mb-0"> {{ $header->title }}</h2>
                                    @else
                                        <h2 class="text-primary fw-bolder mb-0" style="font-size: 20px;">
                                            {{ $header->title }}</h2>
                                    @endif
                                @endforeach

                                <h3 class="text-dark fw-bold pt-1 mb-0">विधुतीय घरनक्सा प्रमाणीकरण प्राणली </h3>
