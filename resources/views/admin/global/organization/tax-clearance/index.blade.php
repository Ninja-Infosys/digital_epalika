    ...
    <div class="card p-0">
        <div class="card-header">
            <div class="d-flex justify-content-between">
                ...
                <a href="{{ route('admin.global.organization.taxClearance.create') }}" class="btn btn-outline-primary btn-xs">
                ...
                <tbody>
                    @foreach ($taxClearances as $taxClearance)
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    <a href="{{ route('admin.global.organization.taxClearance.edit', $taxClearance) }}"
                                        class="btn btn-sm btn-outline-warning mx-1">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <form action="{{ route('admin.global.organization.taxClearance.destroy', $taxClearance) }}"
                                        method="post">
                                        @csrf
                                        @method('delete')
