                    ...
                    <form action="{{ route('admin.global.generalSetting.employee.update', $employee) }}" method="POST"
                        ...
                        <fieldset class="border p-2 mb-2">
                            ...
                            <div class="row">
                                    ...
                                    <select class="form-control @error('gender') is-invalid @enderror" name="gender"
                                        ...
                                        @foreach (\App\Enums\Gender::cases() as $case)
                                            <option value="{{ $case->value }}"
                                                @if ($employee->gender == $case) selected @endif> {{ $case->label() }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-4 mb-2">
                                    <x-date-input-component nameNe="dob" labelNe="जन्म मिति*" nameEn="dob_ad"
                                        labelEn="Birth Date" :getTodayDate="false" />
                                </div>
                                <div class="col-md-4 mb-2">
                                    <label for="pan_no" class="form-label">पाना नं *</label>
                                    <input type="text" name="pan_no" value="{{ old('pan_no', $employee->pan_no) }}"
                                        class="form-control @error('pan_no') is-invalid @enderror" id="pan_no"
                                        placeholder="पाना नं *" />
                                    @error('pan_no')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    ...
                                    <select class="form-control @error('ethnicity_id') is-invalid @enderror"
                                        ...
                                        @foreach ($ethnicities as $ethnicity)
                                            <option value="{{ $ethnicity->id }}"
                                                {{ old('ethnicity_id', $employee->ethnicity_id) == $ethnicity->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input type="text" name="pis_no" value="{{ old('pis_no', $employee->pis_no) }}"
                                        class="form-control @error('pis_no') is-invalid @enderror" id="pis_no"
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input type="text" name="epf_no" value="{{ old('epf_no', $employee->epf_no) }}"
                                        class="form-control @error('epf_no') is-invalid @enderror" id="epf_no"
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input type="text" name="cif_no" value="{{ old('cif_no', $employee->cif_no) }}"
                                        class="form-control @error('cif_no') is-invalid @enderror" id="cif_no"
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input type="checkbox" name="is_dept_head" value="1"
                                        class="@error('is_dept_head') is-invalid @enderror" id="is_dept_head"
