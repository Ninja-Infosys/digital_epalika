                        ...
                        <fieldset class="border p-2 mb-2">
                            ...
                            <div class="row">
                                    ...
                                    <select class="form-control @error('gender') is-invalid @enderror" name="gender"
                                        ...
                                        @foreach (\App\Enums\Gender::cases() as $case)
                                            <option value="{{ $case->value }}"
                                                {{ old('gender') == $case->value ? 'selected' : '' }}>{{ $case->label() }}
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('gender')
                                    ...
                                    <select class="form-control @error('ethnicity_id') is-invalid @enderror"
                                        ...
                                        @foreach ($ethnicities as $ethnicity)
                                            <option value="{{ $ethnicity->id }}"
                                                {{ old('ethnicity_id') == $ethnicity->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input type="text" name="pis_no" value="{{ old('pis_no') }}"
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input type="text" name="epf_no" value="{{ old('epf_no') }}"
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input type="text" name="cif_no" value="{{ old('cif_no') }}"
