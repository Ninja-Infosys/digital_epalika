                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex flex-wrap align-items-center">
                            @includeIf('inc.filter_form')
                                <a href="{{route('admin.generalSetting.employee.qualification.create',$employee)}}" class="btn btn-sm btn-outline-primary waves-effect waves-light">
                            ...
                            @forelse($qualifications as $qualification)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a data-bs-type="edit" href="{{route('admin.generalSetting.employee.qualification.edit',[$employee,$qualification])}}"
                                           class="btn btn-xs btn-outline-primary {{get_setting('Pin')?'confirm_pin' : ''}}" title="सम्पादन गर्नुहोस्">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <form action="{{route('admin.generalSetting.employee.qualification.destroy',[$employee,$qualification])}}"
                                              method="post">
                                            @csrf
                                            @method('delete')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex flex-wrap align-items-center">
                            @includeIf('inc.filter_form')
                            <a href="{{route('admin.generalSetting.employee.experience.create',$employee)}}" class="btn btn-sm btn-outline-primary waves-effect waves-light">
                                <i class="fa fa-plus-circle"></i> नयाँ थप्नुहोस्</a>
                            ...
                            @forelse($experiences as $experience)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a data-bs-type="edit" href="{{route('admin.generalSetting.employee.experience.edit',[$employee,$experience])}}"
                                           class="btn btn-xs btn-outline-primary {{get_setting('Pin')?'confirm_pin' : ''}}" title="सम्पादन गर्नुहोस्">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <form action="{{route('admin.generalSetting.employee.experience.destroy',[$employee,$experience])}}"
                                              method="post">
                                            @csrf
                                            @method('delete')
                                            <button data-bs-type="delete" class="btn btn-xs btn-outline-danger {{get_setting('Pin')?'confirm_pin' : 'show_confirm'}}" title="मेटाउनु होस्">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex flex-wrap align-items-center">
                            @includeIf('inc.filter_form')
                            <a href="{{route('admin.generalSetting.employee.experienceFile.create',$employee)}}" class="btn btn-sm btn-outline-primary waves-effect waves-light">
                                <i class="fa fa-plus-circle"></i> नयाँ थप्नुहोस्</a>
                            ...
                            @forelse($experienceFiles as $experienceFile)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a data-bs-type="edit" href="{{route('admin.generalSetting.employee.experienceFile.edit',[$employee,$experienceFile])}}"
                                           class="btn btn-xs btn-outline-primary {{get_setting('Pin')?'confirm_pin' : ''}}" title="सम्पादन गर्नुहोस्">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <form action="{{route('admin.generalSetting.employee.experienceFile.destroy',[$employee,$experienceFile])}}"
                                              method="post">
                                            @csrf
                                            @method('delete')
                                            <button data-bs-type="delete" class="btn btn-xs btn-outline-danger {{get_setting('Pin')?'confirm_pin' : 'show_confirm'}}" title="मेटाउनु होस्">
