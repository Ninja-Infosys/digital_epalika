            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="{{route('admin.website.slider.index')}}" class="btn btn-sm btn-outline-primary">
                            <i class="fa fa-list"></i> स्लाइडर सूची
                        </a>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{route('admin.website.slider.update',$slider)}}" enctype="multipart/form-data" method="post">
                        @csrf
                        @method('put')
                        <div class="row">
