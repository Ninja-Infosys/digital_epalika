                                ...
                                <tr>
                                    ...
                                    <td>
                                        @can('executiveCommittee_access')
                                            <a data-bs-type="edit" href="{{route('admin.listRegistrations.listRegistration.show', $listRegistration)}}" class="btn btn-xs btn-outline-primary {{get_setting('Pin')?'confirm_pin':''}}">
