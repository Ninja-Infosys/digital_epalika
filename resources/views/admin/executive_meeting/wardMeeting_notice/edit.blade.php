    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('admin.executiveMeeting.wardMeetingNotice.update',$wardMeetingNotice)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        ...
                        <fieldset class="border p-2 mb-2">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-2">
                                    ...
                                    @livewire('executive-meeting.meeting-notice',['meetingNotice'=>$wardMeetingNotice])
                                    @error('type')
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input
                                        ...
                                        value="{{old('meeting_subject',$wardMeetingNotice->meeting_subject)}}"
                                ...
                                <div class="col-md-3 mb-2">
                                    ...
                                    <input
                                        type="text"
                                        name="broadcast_date"
                                        value="{{old('broadcast_date',$wardMeetingNotice->broadcast_date ? $wardMeetingNotice->broadcast_date->toDateString() : '')}}"
                                ...
                                <div class="col-md-3 mb-2">
                                    ...
                                    <input
                                        type="time"
                                        name="broadcast_time"
                                        value="{{old('broadcast_time',$wardMeetingNotice->broadcast_time)}}"
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <textarea name="description"
                                              ...
                                              class="form-control @error('description') is-invalid @enderror">{{old('description',$wardMeetingNotice->description)}}</textarea>
                                    @error('description')
                                    <div class="invalid-feedback">{{$message}}</div>
                                    @enderror
                                </div>
