    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('admin.executiveMeeting.wardMeetingDecision.update',$wardMeetingDecision)}}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <select name="meeting_detail_id"
                                        ...
                                        @foreach($meetingDetails as $meetingDetail)
                                            <option
                                                value="{{$meetingDetail->id}}" {{old('meeting_detail_id',$wardMeetingDecision->meeting_detail_id)==$meetingDetail->id ? 'selected':''}}>
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input
                                        type="text"
                                        name="date"
                                        value="{{old('date',$wardMeetingDecision->date ? $wardMeetingDecision->date->toDateString() : '')}}"
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <textarea name="description" id="description" cols="30" placeholder="बिवरण" rows="5"
                                              class="form-control @error('meeting_subject') is-invalid @enderror">{{old('description',$wardMeetingDecision->description)}}</textarea>
                                    @error('description')
                                    <div class="invalid-feedback">{{$message}}</div>
                                    @enderror
                                </div>
                                <div class="col-md-12 mb-2">
                                    <label for="decision_file" class="form-label">निर्णय फाईल </label>
                                    <input
                                        type="file"
                                        name="decision_file"
