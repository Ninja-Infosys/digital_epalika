        ...
        <div class="row modules">
                ...
                <div class="info-card module-card">
                    <a href="{{route('grievanceHandling.grievance')}}">
                        <div class="pt-4 text-center">
                            <img src="{{asset('assets/frontend/image/new-icons/chat.png')}}" width="35" height="35">
            ...
            <div class="col-md-4">
                <div class="info-card module-card">
                    <a href="{{route('ebps')}}">
                        <div class="pt-4 text-center">
                            <img src="{{asset('assets/frontend/image/new-icons/map.png')}}" width="35" height="35">
            ...
            <div class="col-md-4">
                <div class="info-card module-card">
                    <a href="{{route('digitalBoard.helpdesk.helpdesk')}}">
                        <div class="pt-4 text-center">
                            <img src="{{asset('assets/frontend/image/new-icons/help.png')}}" width="35" height="35">
            ...
            <div class="col-md-4">
                <div class="info-card module-card">
                    <a href="{{route('businessRegistration.business')}}">
                        <div class="pt-4 text-center">
                            <img src="{{asset('assets/frontend/image/new-icons/flat.png')}}" style="object-fit: contain; height: 35px; width: 35px" width="50"
                                height="50">
            ...
            <div class="col-md-4">
                <div class="info-card module-card">
                    <a href="{{route('grant.index')}}">
                        <div class="pt-4 text-center">
                            <img src="{{asset('assets/frontend/image/new-icons/salary.png')}}" width="35" height="35">
            ...
            <div class="col-md-4">
                <div class="info-card module-card">
                    <a href="https://pams.fcgo.gov.np/">
                        <div class="pt-4 text-center">
                            <img src="{{asset('assets/frontend/image/new-icons/verified.png')}}" width="35" height="35">
            ...
            <div class="col-md-4">
                <div class="info-card module-card">
                    <a href="https://public.donidcr.gov.np/">
                        <div class="pt-4 text-center">
                            <img src="{{asset('assets/frontend/image/new-icons/car-accident.png')}}" width="35" height="35">
            ...
            <div class="col-md-4">
                <div class="info-card module-card">
                    <a href="https://ss.donidcr.gov.np/">
                        <div class="pt-4 text-center">
                            <img src="{{asset('assets/frontend/image/new-icons/account.png')}}" width="35" height="35">
            ...
            <div class="col-md-4">
                <div class="info-card module-card">
                    <a href="https://mail.nepal.gov.np/">
                        <div class="pt-4 text-center">
                            <img src="{{asset('assets/frontend/image/new-icons/email.png')}}" width="35" height="35">
            ...
            <div class="col-md-4">
                <div class="info-card module-card">
                    <a href="https://attendance.gov.np/">
                        <div class="pt-4 text-center">
                            <img src="{{asset('assets/frontend/image/new-icons/attendance.png')}}" width="35" height="35">
