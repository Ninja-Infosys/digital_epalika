...
<fieldset>
  ...
  <div class="row">
    ...
    <div class="col-md-4 mb-2">
      ...
      <div class="d-flex justify-content-between gap-1">
        <select id="sipharis_sub_category_id" wire:model="selectedSubcategory" name="sipharis_sub_category_id" class="form-select @error('sipharis_sub_category_id') is-invalid @enderror" personalDetail">
        <option value="">-- छान्नुहोस् --</option>
    ...
    <div class="col-md-4 mb-2">
      <label for="personal_detail_id" class="form-label">सिफारिस उप-श्रेणी <span class="text-danger">*</span></label>
      <div class="d-flex justify-content-between gap-1">
        <select id="sipharis_form_type_id"  wire:model="selectedFormType" name="sipharis_form_type_id" class="form-select @error('sipharis_form_type_id') is-invalid @enderror" personalDetail">
          <option value="">-- छान्नुहोस् --</option>
        ...
        <div class="main">
          ...
          <div class="row border-bottom mb-2">
            ...
            <div class="col-md-6 mb-2">
              <label for="title" class="form-label">Field Name</label>
              <input type="text" value="{{$field->field_name}}" class="form-control" id="title" disabled />
            </div>

            <div class="col-md-6 mb-2">
              <label for="title" class="form-label">शिर्षक</label>
              <input type="text" name="field[{{$key}}][value]" class="form-control" id="title" placeholder="शिर्षक" />
            </div>
          </div>
